...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="<?php echo e(cdn('theme/assets/css/new/pop_up.css')); ?>" />
      <link rel="stylesheet" href="<?php echo e(cdn('theme/assets/css/new/normalize.css')); ?>" />
      <link rel="stylesheet" href="<?php echo e(cdn('theme/assets/css/new/core.css')); ?>" />
   ...
   <body onload="tabclick('<?php echo e($videos); ?>', '<?php echo e($details['id']); ?>', '<?php echo e($lastVideoSeen); ?>', '<?php echo e($event_statistic_id); ?>','<?php echo e($course); ?>','<?php echo e($notes); ?>', '<?php echo e($videos_progress); ?>')">
         ...
         <div class="content-wrapper">
            <div class="sidebar-wrapper open jsSidebar">
               ...
               <div class="sidebar-content">
                  <nav>
                     <ul id="<?php echo e($details['id']); ?>" class="topics-list">
                        <?php
                           $catId = -1;
                           $firstTab =true;
                           $firstLesson =true;
                        ...
                        <?php
                           ...
                           ?>
                        <?php $__currentLoopData = $topics['topics']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyTopic => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                           if($count == 1)
                              // $count = 2;
                           ?>
                        <li class="topic" data-count="<?php echo e($count); ?>">
                           <?php $count++; ?>
                           <a href="javascript:void(0)" tabindex="0" class="topic-header">
                              <div class="topic-info">
                                 <h3
                                    class="topic-info_title"
                                    data-title="<?php echo $keyTopic; ?>"
                                    data-topic-slug = "<?php echo e(\Illuminate\Support\Str::slug(preg_replace('/[0-9]+/', '', $keyTopic))); ?>"
                                    >
                                    <?php echo $keyTopic; ?>
                           ...
                           <ul class="lessons-list">
                              ...
                              <?php $__currentLoopData = $topic['lessons']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $keyLesso => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php
                                ...
                                ?>
                              <li class="lesson <?php echo e($vimeoVideo[1]); ?>" data-completed="<?php echo e($video_seen[$vimeoVideo[1]]['seen']); ?>" data-link="<?php echo e($lesson['links']); ?>" data-note="<?php echo e($notesss[$vimeoVideo[1]]); ?>" id="<?php echo e($frame1); ?>">
                                 <a class="" href="javascript:void(0)" onclick="play_video('<?php echo e($path); ?>','<?php echo e($frame1); ?>','{video<?php echo e($lesson['id']); ?>}', '<?php echo e($lesson['id']); ?>')" tabindex="0">
                                    <img
                                    ...
                                    <div class="lesson-info">
                                       <h3
                                          class="lesson-info_title <?php if($lesson['bold']): ?>bold-topic <?php endif; ?>"
                                          data-title="<?php echo $lesson['title']; ?>"
                                          >
                                          <?php echo $lesson['title']; ?>

                                       </h3>
                                       <span class="lesson-info_duration"><?php echo e($lesson['vimeo_duration']); ?></span>
                                       <span class="white-separator"> | </span>
                                       <?php if(isset($lesson['type'][0]['name'])): ?><span class="lesson-info_topic-type"><?php echo e($lesson['type'][0]['name']); ?></span><?php endif; ?>
                                    ...
                                    <div class="lesson-teacher-wrapper">
                                       ...
                                       <img
                                          ...
                                          src="<?php echo e(cdn(get_image($instructor['mediable'],'instructors-small'))); ?>"
                                          alt="<?php echo e($instructor['title']); ?> <?php echo e($instructor['subtitle']); ?>"
                                          title="<?php echo e($instructor['title']); ?> <?php echo e($instructor['subtitle']); ?>"
                                          data-slug="<?php echo e($instructor['slugable']['slug']); ?>"
                                          />
                                    </div>
            ...
            <div class="lesson-wrapper jsLesson">
               ...
               <!-- ./lesson-header -->
               <div id="<?php echo e($lesson['event_id']); ?>" class="video-wrapper">
                  <div id='<?php echo e($frame2); ?>'>
                     <iframe
                        aria-label="lesson video"
                        src='https://player.vimeo.com/video/<?php echo e($lastVideoSeen); ?>?color=efc900&title=0&byline=0&autoplay=1&loop=0&autopause=0'
                        style="
                        position: absolute;
                        top: 0;
                        left: 0;
               ...
               <div class="lesson-main">
                  <div class="lesson-main-title-wrapper">
                     <h2 class="lesson-main-title"><?php echo $lesson['title']; ?></h2>
                           ...
                           <div class="lesson-downloads">
                              ...
                              <ul class="resource-list">
                                 ...
                                 <?php $__currentLoopData = $folders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key11 => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    

                                       <?php if($folder['id'] == $file['fid']): ?>
                                       <li id="<?php echo e($folder['dirname']); ?>" data-folder-id="<?php echo e($topic_name); ?>" class="resource hidden">
                                          <a class="download-file getdropboxlink"  data-dirname="<?php echo e($file['dirname']); ?>" data-filename="<?php echo e($file['filename']); ?>" href="javascript:void(0)" ><img
                                             src="theme/assets/img/new/download.svg"
                                             alt="download resource" /><?php echo e($file['filename']); ?></a
                                             >
                                 ...
                                 <?php if(isset($files_bonus) && count($files_bonus) > 0 && isset($files) && count($files) > 0): ?>
                                          ...
                                          <?php if($folder_bonus['parent'] == $folder['id']): ?>
                                             ...
                                             <?php $__currentLoopData = $files_bonus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file_bonus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($file_bonus['parent'] == $folder_bonus['parent']  ): ?>
                                                   <li id="<?php echo e($folder_bonus['dirname']); ?>" data-folder-id="<?php echo e($topicNames[$folder_bonus['parent']]); ?>" class="resource bonus-files hidden">
                                                      <a class="download-file getdropboxlink"  data-dirname="<?php echo e($file_bonus['dirname']); ?>" data-filename="<?php echo e($file_bonus['filename']); ?>" href="javascript:void(0)" ><img
                                                         src="theme/assets/img/new/download.svg"
                                                         alt="download resource" /><?php echo e($file_bonus['filename']); ?></a>
                                                   </li>
                                                <?php endif; ?>
                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                          <?php endif; ?>
      ...
      <script
         ...
         crossorigin="anonymous"
         ></script>
      <script src="<?php echo e(cdn('theme/assets/js/new_js1/app1.js')); ?>"></script>
                ...
                <?php if(!$instructor_topics): ?>
                   ...
                   if(e['percent'] >= 0.8){
                      if(videos[videoId]['seen'] == 0){
                         ...
                         document.getElementById('play-image-account'+videos[videoId]['lesson_id']).setAttribute('src',"<?php echo e(cdn('/theme/assets/images/icons/check_lesson.svg')); ?>")
      ...
      <script>
         function notLogin(data){
            ...
            let p = ''
            p = `<img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-success-alert.svg')); ?>" alt="Info Alert">` + data['message'];
            $('#message').append(p);
...
<?php /**PATH C:\laragon\www\kcversion8\resources\views/theme/myaccount/newelearning.blade.php ENDPATH**/ ?>