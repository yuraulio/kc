...
<div class="col12  installments-fields">
    ...
    <div class="custom-radio-wrapper small-radio">
        ...
        <div class="label-wrapper">
            <label for="radio-installment-full-control">Payment in full <span class="ticket-coupon">€<?php echo e($instOne); ?></span>.</label>
        </div>
        </div>
        ...
        <div class="label-wrapper">
            <label for="radio-installment-2-control">2 installments: <span class="ticket-coupon-inst2">2x €<?php echo e($instTwo); ?></span>.</label>
        ...
        <div class="label-wrapper">
            <label for="radio-installment-3-control">3 installments: <span class="ticket-coupon-inst3">3x €<?php echo e($instThree); ?></span>.</label>
        ...
        <div class="card-body">
            ...
            <div class="row align-items-center">
                <div class="col-auto">
                    <!-- Avatar -->
                    <?php //dd($default_card); ?>
                    <?php if($default_card && $default_card->brand == 'visa'): ?>
                        <?php $brand = 'Visa' ?>
                        <img style="padding:10px" id="icon_card" alt="Image placeholder" src="<?php echo e(asset('argon')); ?>/img/icons/cards/visa.svg">
                    <?php else: ?>
                        <?php $brand = 'Mastercard' ?>
                        <img style="padding:10px" id="icon_card" alt="Image placeholder" src="<?php echo e(asset('argon')); ?>/img/icons/cards/master.svg">
                    <?php endif; ?>

                </div>
                <div class="col ml--2">
                    <b id="brand-sec" style="margin-right:2rem;" class="mb-0"> <?php echo e($brand); ?></b>
                    <b style="margin-right:0.5rem;" class="mb-0"> **** </b>
                    <b id="last4" class="mb-0"><?php if($default_card): ?> <?php echo e($default_card->last4); ?> <?php endif; ?></b>

                    <p class="text-sm text-muted mb-0"><span style="margin-right:0.8rem;">Expires: </span><span id="exp_month"><?php if($default_card): ?> <?php echo e($default_card->exp_month); ?><?php endif; ?></span>/<span id="exp_year"><?php if($default_card): ?><?php echo e($default_card->exp_year); ?> <?php endif; ?></span></p>
...
<?php /**PATH C:\laragon\www\kcversion8\resources\views/theme/cart/stripe-form.blade.php ENDPATH**/ ?>