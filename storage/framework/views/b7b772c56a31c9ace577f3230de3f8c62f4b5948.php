                  ...
                  <div class="header-actions clearfix">
                     <ul class="actions-list">
                        ...
                        <li class="account-menu">
                           <a href="javascript:void(0)" title="Superhero Login"><img src="<?php echo e(cdn('/theme/assets/images/icons/knowcrunch-superhero-icons-login.svg')); ?>" class="replace-with-svg" alt="Superhero Login"></a>
                           <div class="account-submenu">
                              <ul>
                                 <li><a href="/myaccount">Account</a></li>
                                 <li><a href="<?php echo e(url('logmeout')); ?>">Sign Out</a></li>
                              </ul>
                           </div>
                        </li>
                        <?php else: ?>
                        <li class="account-menu">
                           <a href="javascript:void(0)" title="Superhero Login"><img src="<?php echo e(cdn('/theme/assets/images/icons/knowcrunch-superhero-icons-login.svg')); ?>" class="replace-with-svg" width="18" alt="Superhero Login"></a>
                        </li>
                        <?php endif; ?>
                        <li class="header-search-area">
                           <a href="#" title="Search" class="search-toggle"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-magnifier.svg')); ?>" class="replace-with-svg" width="22" alt="Search"></a>
   ...
   <div class="mob-menu-inner">
      ...
      <form method="get" action="search/term">
          <?php echo e(csrf_field()); ?>
            ...
            <button type="submit"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-magnifier.svg')); ?>" class="replace-with-svg" alt=""/></button>
         </form>
      </div>
      <div class="menu-wrapper">
         <ul class="mob-menu">
            <?php if(!empty($data['filter_type'])): ?>
            <?php $__currentLoopData = $data['filter_type']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <li><a href="/myaccount">Account</a></li>
            <li class="nav-item">
               <a href="<?php echo e(url('logmeout')); ?>">Sign out</a>
            </li>
            <?php else: ?>
            <li class="account-menu">
...
<div class="alert-outer" hidden>
    ...
    <div id="login-popup" class="login-popup">
        ...
        <span>Account login</span>
            ...
            <div class="input-wrapper input-wrapper--text input-wrapper--email">
                <span class="icon"><img width="14" src="<?php echo e(cdn('/theme/assets/images/icons/icon-email.svg')); ?>" class="replace-with-svg" alt=""></span>
                <input type="text" placeholder="Email" id="email">
            </div>
            <div class="input-wrapper input-wrapper--text">
                <span class="icon"><img width="10" src="<?php echo e(cdn('/theme/assets/images/icons/icon-lock.svg')); ?>" class="replace-with-svg" alt=""></span>
    ...
    <div id="forgot-pass-input" class="login-popup" hidden>
        <a href="#" class="close-btn"><img width="26" src="<?php echo e(cdn('theme/assets/images/icons/icon-close.svg')); ?>" alt="Close"></a>
        <div class="heading">
...
<?php endif; ?>
         <?php echo $__env->yieldContent('message_page'); ?>
         <footer id="footer">
                     ...
                     <div class="mobile-toggle">
                        <div class="footer-form">
                           ...
                           <div id="mc_embed_signup">
                              <form  class="form-control validate" action="//knowcrunch.us15.list-manage.com/subscribe/post?u=312b4ca8015cf92c92eeb4dbb&amp;id=ec4847fa7b" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" target="_blank" novalidate>
                                 <div id="mc_embed_signup_scroll">
                                    ...
                                    <input type="text" id="mce-EMAIL" name="EMAIL" placeholder="E-mail address *" required />
...
<?php /**PATH C:\laragon\www\kcversion8\resources\views/errors/master.blade.php ENDPATH**/ ?>