...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title itemprop="name"><?php echo e($metaTitle ?? 'Knowcrunch Admin Dashboard'); ?></title>
        ...
        <!-- Favicon -->
        <link href="<?php echo e(asset('')); ?>/favicon/favicon-32x32.png" rel="icon" type="image/png">
        <!-- Fonts -->
        ...
        <link href="<?php echo e(asset('argon')); ?>/vendor/select2/dist/css/select2.min.css" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo e(asset('vendor/file-manager/css/file-manager.css')); ?>">
        <link href="<?php echo e(asset('argon')); ?>/vendor/cropper/dist/cropper.min.css" rel="stylesheet">
        <link rel="stylesheet" href="<?php echo e(asset('argon')); ?>/vendor/sweetalert2/dist/sweetalert2.min.css">
        <link href="<?php echo e(asset('argon')); ?>/vendor/timepicker/jquery.timepicker.min.css" rel="stylesheet">
        ...
        <!-- Argon CSS -->
        <link type="text/css" href="<?php echo e(asset('css')); ?>/argon.css?v=2.0.0" rel="stylesheet">
    ...
    <body class="<?php echo e($class ?? ''); ?>">
        ...
        <script src="<?php echo e(asset('argon')); ?>/vendor/lavalamp/js/jquery.lavalamp.min.js"></script>
        <!-- Optional JS -->
        ...
        <script src="<?php echo e(asset('argon')); ?>/vendor/select2/dist/js/select2.min.js"></script>
        <script src="<?php echo e(asset('argon')); ?>/vendor/dropzone/dist/min/dropzone.min.js"></script>
        <script id="file-js" src="<?php echo e(asset('vendor/file-manager/js/file-manager.js')); ?>"></script>
        <script src="<?php echo e(asset('argon')); ?>/vendor/cropper/dist/cropper.min.js"></script>
        ...
        <script src="<?php echo e(asset('argon')); ?>/vendor/timepicker/jquery.timepicker.min.js"></script>
        ...
        <!-- Argon JS -->
        <script src="<?php echo e(asset('argon')); ?>/js/argon.js?v=1.0.1"></script>
        <script src="<?php echo e(asset('argon')); ?>/js/demo.min.js"></script>

    </body>
</html>
<?php /**PATH C:\laragon\www\kcversion8\resources\views/layouts/app.blade.php ENDPATH**/ ?>