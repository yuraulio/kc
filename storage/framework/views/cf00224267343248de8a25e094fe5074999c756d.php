<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item active" aria-current="type"><?php echo e(__('Add Venues')); ?></li>
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form method="post" action="<?php echo e(route('venue.store_main')); ?>" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group<?php echo e($errors->has('address') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="text" name="address" id="input-address" class="form-control<?php echo e($errors->has('address') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Address')); ?>" value="<?php echo e(old('address')); ?>" autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('longitude') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="number" name="longitude" id="input-longitude" class="form-control<?php echo e($errors->has('Longitude') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('longitude')); ?>" value="<?php echo e(old('longitude')); ?>" autofocus>
                                ...
                                <div class="form-group<?php echo e($errors->has('latitude') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="number" name="latitude" id="input-latitude" class="form-control<?php echo e($errors->has('latitude') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Latitude')); ?>" value="<?php echo e(old('latitude')); ?>" autofocus>
...
<?php echo $__env->make('layouts.app', [
    'title' => __('Venues Management'),
    'parentSection' => 'laravel',
    'elementName' => 'venues-management'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/venue/main/create.blade.php ENDPATH**/ ?>