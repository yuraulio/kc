...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item"><a href="#"><?php echo e(__('Plan Management')); ?></a></li>
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('plan.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Plan')); ?></a>
                            </div>
                        ...
                        <table class="table table-flush"  id="datatable-basic18">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('plan.edit', $plan->id)); ?>"> <?php echo e($plan->name); ?> </a></td>
                                            ...
                                            <?php //dd($user); ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('plan.edit', $plan->id)); ?>"><?php echo e(__('Edit')); ?></a>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/subscription/plans_list.blade.php ENDPATH**/ ?>