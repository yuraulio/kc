...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('ticket.index')); ?>"><?php echo e(__('Tickets Management')); ?></a></li>
                        ...
                        <div class="row align-items-center">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Model\User::class)): ?>
                                <div class="col-4 text-right">
                                    <a href="<?php echo e(route('ticket.create_main')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add ticket')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center table-flush"  id="datatable-basic38">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col"><?php echo e(__('Assiged to event')); ?></th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('ticket.edit_main', $ticket)); ?>"><?php echo e($ticket->title); ?></a></td>
                                        <td><?php echo e($ticket->subtitle); ?></td>
                                        <td><?php echo e($ticket->type); ?></td>
                                        <td><?php echo e($ticket->features); ?></td>
                                        <td>
                                            <?php if(count($ticket->events) != 0): ?>
                                                <?php $__currentLoopData = $ticket->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                        ...
					                        <td class="text-right">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item" href="<?php echo e(route('ticket.edit_main', $ticket)); ?>"><?php echo e(__('Edit')); ?></a>

                                                        <form action="<?php echo e(route('ticket.destroy', $ticket)); ?>" method="post">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('delete'); ?>

                                                            <button type="button" class="dropdown-item" onclick="confirm('<?php echo e(__("Are you sure you want to delete this Ticket?")); ?>') ? this.parentElement.submit() : ''">
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/ticket/main/index.blade.php ENDPATH**/ ?>