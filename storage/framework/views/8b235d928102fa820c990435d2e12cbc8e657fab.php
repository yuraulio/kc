					...
					<?php $cartitems = Cart::content()->count(); ?>
						...
						<button class="hamburger hamburger--spin mob-menu-btn" type="button">
						  	...
						  	<span class="hamburger-box">
								...
								<?php if($cartitems > 0): ?>
								<span class="cart-number"><?php echo e(Cart::content()->count()); ?></span>
								<?php endif; ?>
						  	</span>
						</button>
						...
						<div class="header-actions clearfix">
							<ul class="actions-list">
                                ...
                                <?php if($cartitems > 0): ?>
								    <li class="cart-menu">
                                        <a href="/cart" title="Cart"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-cart.svg')); ?>" class="replace-with-svg" width="18" alt="Cart">
                                          <span class="cart-number"><?php echo e(Cart::content()->count()); ?></span>
                                        </a>
                                    </li>
								<?php endif; ?>
                                ...
                                <li class="account-menu login-pad">
									<a href="javascript:void(0)" title="Superhero Login">
										...
										<img class="login-image" src="<?php echo e(cdn($img_src)); ?>" onerror="this.src='<?php echo e(cdn('/theme/assets/images/icons/user-profile-placeholder-image.png')); ?>'" alt="user-profile-placeholder-image"/>
                                ...
                                <li class="header-search-area">
									<a href="javascript:void(0)" title="Search" class="search-toggle"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-magnifier.svg')); ?>" class="replace-with-svg" alt="Search"></a>
...
<?php /**PATH C:\laragon\www\kcversion8\resources\views/theme/layouts/header.blade.php ENDPATH**/ ?>