...
<div class="row align-items-center">
    <div class="col-8">
        <h3 class="mb-0"><?php echo e(__('Partners')); ?></h3>
        <p class="text-sm mb-0">
            <?php echo e(__('This is an example of partner management. This is a minimal setup in order to get started fast.')); ?>

        </p>
    </div>
    <div class="col-4 text-right">
    <button data-toggle="modal" data-target="#partnerModal" class="btn btn-sm btn-primary"><?php echo e(__('Assign partner')); ?></button>
    </div>
</div>

<div class="table-responsive py-4">
    <table class="table align-items-center table-flush"  id="datatable-basic16">
        ...
        <?php if($model->partners): ?>
            <?php $__currentLoopData = $model->partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="partner-<?php echo e($partner->id); ?>">
                    ...
                    <td class="text-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <a class="dropdown-item" id="remove_partner" data-partner-id="<?php echo e($partner->id); ?>"><?php echo e(__('Remove')); ?></a>
                            </div>
                        </div>
                    </td>
                </tr>
   ...
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         ...
         <div class="modal-body">
            <h6 class="heading-small text-muted mb-4"><?php echo e(__('Partner information')); ?></h6>
            <div class="pl-lg-4">
                <form>
                    <div class="pl-lg-4">
         ...
         <div class="modal-footer">
            ...
            <button type="button" data-event-id="<?php echo e($model->id); ?>" id="save_partner_btn" class="btn btn-primary">Save changes</button>
         </div>
      </div>
   </div>
</div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $.ajax({
            ...
            type: 'post',
            url: '<?php echo e(route("partner.remove_event")); ?>',
        ...
        $.ajax({
            ...
            type: 'post',
            url: '<?php echo e(route("partner.store_event")); ?>',
            ...
            success: function (data) {
                ...
                `<div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    <a class="dropdown-item" data-partner-id="`+partner['id']+`" id="remove_partner"><?php echo e(__('Remove')); ?></a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/partner/event/index.blade.php ENDPATH**/ ?>