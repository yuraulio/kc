...
<?php if((isset($info) && isset($info['success'])) && $info['success'] === true): ?>
            ...
            <div class="row row-flex">
               ...
               <div class="col-5 col-sm-12">
                  <div class="image-wrapper">
                     <img src="<?php echo e(cdn('/theme/assets/images/thank-you-img.png')); ?>" alt="Thank You"/>
                  </div>
               </div>
            </div>
         </div>
...
<!--   NOT LOGIN    -->
<?php elseif(!Auth::check() && sizeof(Cart::content()) != 0): ?>
               ...
               <div class="col8 col-md-7 col-sm-12">
                  <div class="tabs-forms">
                     <div class="tab-controls">
                        <ul>
                           <li><a href="#existing-customer" <?php if(!session()->has('create_tab') && (!isset($couponEvent) || !$couponEvent )): ?> class="active" <?php endif; ?>>Login</a></li>
                           <li><a href="#new-customer" <?php if(session()->has('create_tab') || (isset($couponEvent) && $couponEvent )): ?> class="active" <?php endif; ?>>Create account</a></li>
                        </ul>
                        <!-- /.tab-controls -->
                     </div>
                     <div class="tabs-content">
                        <div id="existing-customer" class="tab-content-wrapper <?php if(!session()->has('create_tab') && (!isset($couponEvent) || !$couponEvent ) ): ?> active-tab <?php endif; ?> ">
                           ...
                           <div class="container">
                              <div class="alert-wrapper success-alert">
                                 <div class="alert-inner">
                                    <p><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-success-alert.svg')); ?>" alt="Info Alert"><?php echo e(session()->get('message')); ?></p>
                        ...
                        <?php endif; ?>
                              ...
                              <form action="<?php echo e(URL::to('checkoutlogin')); ?>" method="post" class="login-form" id="loginf"
                                 ...
                                 <div class="input-wrapper input-wrapper--text input-wrapper--email">
                                    <span class="icon"><img width="12" src="<?php echo e(cdn('/theme/assets/images/icons/icon-email.svg')); ?>" alt=""></span>
                        ...
                        <div id="new-customer" class="tab-content-wrapper <?php if(session()->has('create_tab') || (isset($couponEvent) && $couponEvent )): ?> ) active-tab <?php endif; ?>">

                        <div id="favDialog" hidden>

                           <div class="alert-wrapper error-alert">
                              <div class="alert-inner">
                                 <p><img src="<?php echo e(cdn('theme/assets/images/icons/alert-icons/icon-error-alert.svg')); ?>" alt="Info Alert">Please accept the terms, conditions & data privacy in order to complete your registration.</p>
                                 <a href="javascript:void(0)" class="close-alert"><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-close-alert.svg')); ?>" alt="Close Alert"/></a>
                              </div>
                        ...
                        <?php endif; ?>
                              <form id="new-customer-form" action="<?php echo e(URL::to('kcregister')); ?>" method="post" class="register-form" novalidate autocomplete="off" >
                                 <?php echo csrf_field(); ?>
                                 ...
                                 <div class="row">
                                    <div class="col6 col-sm-12">
                                       ...
                                       <div class="input-safe-wrapper">
                                          <input class="required" id="first_name" type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" required/>
                                       </div>
                                    </div>
                                    <div class="col6 col-sm-12">
                                       <label for="r-last-name">Last name <span>*</span></label>
                                       <div class="input-safe-wrapper">
                                          <input class="required" id="last_name" type="text" name="last_name" value="<?php echo e(old('last_name')); ?>"/>
                                       </div>
                                    </div>
                                    <div class="col6 col-sm-12">
                                       <label for="r-email">Email <span>*</span></label>
                                       <div class="input-safe-wrapper">
                                          <input class="required" id="r-email" type="email" name="email" value="<?php echo e(old('email')); ?>"/>
                                       </div>
                                    </div>
                                    <div class="col6 col-sm-12">
                                       ...
                                       <div class="input-safe-wrapper is-flex full-width">
                                          ...
                                          <input class="required" id="mobile" onkeyup="checkPhoneNumber(this)" type="text"  name="mobile" value="<?php echo e(old('mobile')); ?>"/>
                                          <input type="hidden" name="mobileCheck" id="mobileCheck" value="<?php echo e(old('mobile')); ?>">
                  ...
                  <div class="clearfix">
                     <div class="ticket-sidebar">
                        ...
                        <div class="ticket-infos">
                           <ul>
                              <?php if($city): ?><li><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-marker.svg')); ?>" width="16" alt="" class="icon" /><?php echo e($city); ?></li><?php endif; ?>
                              <?php if($duration): ?><li><img src="<?php echo e(cdn('/theme/assets/images/icons/Start-Finish.svg')); ?>" width="16" alt="" class="icon" /><?php echo e($duration); ?></li><?php endif; ?>
                              <?php if($hours): ?><li><img src="<?php echo e(cdn('/theme/assets/images/icons/Start-Finish.svg')); ?>" alt=""><?php echo e($hours); ?></li><?php endif; ?>

                           </ul>
                        </div>
                        <div class="remove-area ">
                           <img src="<?php echo e(cdn('/theme/assets/images/icons/icon-delete.svg')); ?>" class="replace-with-svg" width="16" alt=""/>
                           <a class="btn-remove" href="<?php echo e($item->rowId); ?>">Remove</a>
                        </div>
...
<?php elseif( sizeof(Cart::content()) != 0 || ((isset($info)) && isset($info['success']) && !$info['success']) || \Session('dperror')): ?>
<main id="main-area" role="main">
<div id="favDialog" hidden>
...
<div id="favDialogCard" hidden>
   ...
   <div class="alert-wrapper error-alert">
      <div class="alert-inner">
         <p><img src="<?php echo e(cdn('theme/assets/images/icons/alert-icons/icon-error-alert.svg')); ?>" alt="Info Alert">Add card to process payment.</p>
         <a href="javascript:void(0)" class="close-alert"><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-close-alert.svg')); ?>" alt="Close Alert"/></a>
      </div>
...
<div id="couponDialog" hidden>
   ...
   <?php if($info['success']==false): ?>
   <div class="alert-outer">
					<div class="container">
						<div class="alert-wrapper error-alert">
							<div class="alert-inner">

								<p><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-error-alert.svg')); ?>" alt="Info Alert"><?php echo e($info['message']); ?>.</p>
								<a href="javascript:void(0)" class="close-alert"><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-close-alert.svg')); ?>" alt="Close Alert"/></a>
							</div>
						</div>
					</div>
   ...
   <?php elseif(\Session('dperror')): ?>
   <div class="alert-outer">
					<div class="container">
						<div class="alert-wrapper error-alert">
							<div class="alert-inner">

								<p><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-error-alert.svg')); ?>" alt="Info Alert"><?php echo e(\Session('dperror')); ?>.</p>
								<a href="javascript:void(0)" class="close-alert"><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-close-alert.svg')); ?>" alt="Close Alert"/></a>
							</div>
						</div>
					</div>
   ...
   <section class="selection-section">
      <div class="container">
         ...
         <div class="your-selection">
            <div class="item">
               <div class="remove-area">
                  <a class="btn-remove" href="<?php echo e($item->rowId); ?>"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-delete.svg')); ?>" class="replace-with-svg" alt=""/><span>Remove</span></a>
               </div>
               <div class="left">
                  <h3><?php echo e($item->name); ?></h3>
                  <div class="bottom">
                     <?php if($city): ?><div class="location"><img src="<?php echo e(cdn('/theme/assets/images/icons/marker.svg')); ?>" alt=""><?php echo e($city); ?></div><?php endif; ?>
                     <?php if($duration): ?><div class="duration"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-calendar.svg')); ?>" alt=""><?php echo e($duration); ?></div><?php endif; ?>
                     <?php if($hours): ?><div class="expire-date"><img src="<?php echo e(cdn('/theme/assets/images/icons/Start-Finish.svg')); ?>" alt=""><?php echo e($hours); ?></div><?php endif; ?>
               ...
               <div class="right">
                  <ul class="checkout-infos">
                     <li>
                        ...
                        <?php if($item->model): ?><span class="value"><?php echo e($item->model->type); ?></span><?php endif; ?>
                     </li>
                     <li>
                        <span class="label">Price:</span>
                        <?php if($price > 0): ?>
                        <span class="value ticket-coupon">€<?php echo e($price); ?></span>
                        <?php else: ?>
                     ...
                     <li class="total-amount">
                        ...
                        <span class="value ticket-coupon">€<?php echo e($item->subtotal); ?></span>
                     </li>
                  </ul>
               </div>
            </div>
         ...
         <div class="checkout-wrapper">
            <div class="row">
               <div class="col8 col-sm-12">
                  <h2>Participant</h2>
                  <div class="form-wrapper">
                     <form method="post" id='user-info' action="/pay-sbt" class="small-form <?php if($thetype==5): ?> participant-form-group <?php endif; ?>">
                        <?php echo e(csrf_field()); ?>

                        <?php if(Cart::instance('default')->subtotal() > 0): ?>
                        <input id="item-quantity" type="hidden" value="<?php echo e($item->qty); ?>" name="update[<?php echo e($item->rowId); ?>][quantity]" value="<?php echo e($item->qty); ?>" />
                        <?php endif; ?>
                        ...
                        <div class="extra-participant-area">
                           ...
                           <h2>
                              <span>Participant <?php echo e($participants); ?></span>
                           ...
                           <div class="row">
                              <div class="col6 col-sm-12">
                                 ...
                                 <div class="input-safe-wrapper">
                                    <input class="required" type="text" id="name<?php echo $i; ?>" name="name[]" placeholder="Name*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['names'][$i])): ?><?php echo e($pay_seats_data['names'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->firstname); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 <label>Last name <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="surname<?php echo $i; ?>" name="surname[]" placeholder="Surname*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['surnames'][$i])): ?><?php echo e($pay_seats_data['surnames'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->lastname); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 <label>Email <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="email" id="email<?php echo $i; ?>" name="email[]" placeholder="Email*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['emails'][$i])): ?><?php echo e($pay_seats_data['emails'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->email); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 ...
                                 <div class="input-safe-wrapper is-flex full-width">
                                    ...
                                    <input class="required"type="text"  onkeyup="checkPhoneNumberParticipant(this,<?php echo $i; ?>)" id="mobile<?php echo $i; ?>" name="mobile[]" placeholder="Mobile*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['mobiles'][$i])): ?><?php echo e($pay_seats_data['mobiles'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->mobile); ?><?php endif; ?>" required />
                                    <input class="required"type="hidden" id="mobileCheck<?php echo $i; ?>" name="mobileCheck[]" placeholder="Mobile*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['mobileCheck'][$i])): ?><?php echo e($pay_seats_data['mobileCheck'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?>+<?php echo e($cur_user->country_code); ?><?php echo e($cur_user->mobile); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 <label>Company </label>
                                    <input type="text" id="company<?php echo $i; ?>" name="company[]" placeholder="Company (if any)" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['companies'][$i])): ?><?php echo e($pay_seats_data['companies'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->company); ?><?php endif; ?>" />

                              </div>
                              <div class="col6 col-sm-12">
                                 <label>Position title </label>
                                 <div class="input-safe-wrapper">
                                          <input class="" type="text" id="jobtitle<?php echo $i; ?>" name="jobtitle[]" placeholder="Title or Job Position" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['jobtitles'][$i])): ?><?php echo e($pay_seats_data['jobtitles'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->job_title); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <?php if($item->options->has('type')): ?>
                              <?php switch( $item->options->type):
                              case (0): ?>
                              ...
                              <div class="input-safe-wrapper">
                                          <input class="required" type="text"  id="studentId" name="studentId[]" placeholder="Unemployed Id*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['studentId'][$i])): ?><?php echo e($pay_seats_data['studentId'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->student_type_id); ?><?php endif; ?>" required>
                              </div>
                              </div>
                              <?php break; ?>
                              <?php case (2): ?>
                              ...
                              <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="studentId" name="studentId[]" placeholder="Student Id*" value="<?php if(isset($pay_seats_data) && isset($pay_seats_data['studentId'][$i])): ?><?php echo e($pay_seats_data['studentId'][$i]); ?><?php elseif(isset($cur_user) && $i == 0): ?><?php echo e($cur_user->student_type_id); ?><?php endif; ?>" required>
                              </div>
                              </div>
                              <?php break; ?>
                              <?php case (3): ?>
                              ...
                              <div class="input-safe-wrapper">
                                 <input class="required" type="text"  id="studentId" name="studentId[]" placeholder="Knowcrunch Id* / Deree Id*" value="<?php if(Auth::check()): ?><?php echo e(Auth::user()->id); ?><?php endif; ?>" required>
                              </div>
                              </div>
                              <?php break; ?>
                              <?php case (4): ?>
                     ...
                     <?php if($thetype==5): ?>
                     <a href="#" class="btn btn--lg btn--secondary btn-add-participant" data-ticket-max = "<?php echo e($themax); ?>" data-participant-number="<?php echo e($item->qty); ?>"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-add-user.svg')); ?>" alt="Add another participant">Add another participant</a>
                     <?php endif; ?>
                  </div>
               </div>
            </div>
                  ...
                  <div class="form-wrapper">
                     <form method="post" id="billing-setting" action="/pay-sbt" class="small-form">
                        ...
                        <div class="row">
                              ...
                              <div class="custom-radio-wrapper">
                                 <div class="custom-radio-box active">
                                    <div class="crb-wrapper">
                                       <input id="radio-receipt-control" name="needbilling" value="1" <?php if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1): ?> checked <?php elseif(!isset($pay_bill_data['billing'])): ?> checked <?php endif; ?> type="radio" data-fieldset-target="receipt-fields" name="billing-receipt-invoice" checked="checked">
                                       <span></span>
                                    </div>
                                 ...
                                 <div class="custom-radio-box">
                                    <div class="crb-wrapper">
                                       <input id="radio-invoice-control" name="needbilling" value="2" <?php if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 2): ?> checked <?php endif; ?> type="radio" data-fieldset-target="invoice-fields" name="billing-receipt-invoice">
                                       <span></span>
                                    </div>
                                    <div class="label-wrapper">
                           ...
                           <?php else: ?>
                           <input hidden id="radio-receipt-control" name="needbilling" value="1" <?php if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1): ?> checked <?php elseif(!isset($pay_bill_data['billing'])): ?> checked <?php endif; ?> type="radio" data-fieldset-target="receipt-fields" name="billing-receipt-invoice" checked="checked">
                           <?php endif; ?>
                           <div>
                           <div class="col12 receipt-fields hidden-fields-actions" style="display:block">
                              ...
                              <label>First name <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                    <input class="required" type="text" id="billname" name="billname" placeholder="Name" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billname'])): ?><?php echo e($pay_bill_data['billname']); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              ...
                              <label>Name or Company <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                    <input class="required" type="text" id="billname" name="billname" placeholder="Name" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billname'])): ?><?php echo e($pay_bill_data['billname']); ?><?php endif; ?>" oninput="billsurname.value = billname.value; return true;" required />
                                 </div>
                              </div>
                              ...
                              <div class="col6 col-sm-12">
                                 <label>Last name <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input  class="required" type="text" id="billsurname" name="billsurname" placeholder="Surname" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billsurname'])): ?><?php echo e($pay_bill_data['billsurname']); ?><?php endif; ?>" required />
                                 </div>
                              </div>

                              <?php else: ?>

                              <input style="display:none"  class="hidden" type="text" id="billsurname" name="billsurname" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billsurname'])): ?><?php echo e($pay_bill_data['billsurname']); ?><?php endif; ?>" oninput="billname.value = billsurname.value; return true;" />

                              <?php endif; ?>
                              <div class="col6 col-sm-12" >
                                 <label>Street <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="billaddress" name="billaddress" placeholder="Street Address" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billaddress'])): ?><?php echo e($pay_bill_data['billaddress']); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 <label>Street number <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="number" id="billaddressnum" name="billaddressnum" placeholder="Street Number" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billaddressnum'])): ?><?php echo e($pay_bill_data['billaddressnum']); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 <label>City <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="billcity" name="billcity" placeholder="City" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billcity'])): ?><?php echo e($pay_bill_data['billcity']); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              <div class="col6 col-sm-12">
                                 <label>Postcode <span>*</span></label>
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="billpostcode" name="billpostcode" placeholder="Post Code" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billpostcode'])): ?><?php echo e($pay_bill_data['billpostcode']); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              ...
                              <div class="col6 col-sm-12">
                                 ...
                                 <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="billafm" name="billafm" placeholder="Α.Φ.Μ." value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['billafm'])): ?><?php echo e($pay_bill_data['billafm']); ?><?php endif; ?>" required />
                                 </div>
                              </div>
                              </div>
                              </div>
                           <div class="col12 hidden-fields-actions invoice-fields">
                              <div class="row">
                                 <div class="col6 col-sm-12">
                                    ...
                                    <div class="input-safe-wrapper">
                                          <input class="required"type="text" id="companyname" name="companyname" placeholder="Επωνυμία εταιρίας" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companyname'])): ?><?php echo e($pay_bill_data['companyname']); ?><?php endif; ?>" required />
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>Δραστηριότητα εταιρίας <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text"id="companyprofession" name="companyprofession" placeholder="Δραστηριότητα εταιρίας" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companyprofession'])): ?><?php echo e($pay_bill_data['companyprofession']); ?><?php endif; ?>" required />
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>Α.Φ.Μ <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="companyafm" name="companyafm" placeholder="Α.Φ.Μ." value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companyafm'])): ?><?php echo e($pay_bill_data['companyafm']); ?><?php endif; ?>" required />
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>ΔΟΥ <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="companydoy" name="companydoy" placeholder="ΔΟΥ" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companydoy'])): ?><?php echo e($pay_bill_data['companydoy']); ?><?php endif; ?>" required />
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>Διεύθυνση <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text" id="companyaddress" name="companyaddress" placeholder="Διεύθυνση" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companyaddress'])): ?><?php echo e($pay_bill_data['companyaddress']); ?><?php endif; ?>">
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>Αριθμός <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="number"  id="companyaddressnum" name="companyaddressnum" placeholder="Αριθμός" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companyaddressnum'])): ?><?php echo e($pay_bill_data['companyaddressnum']); ?><?php endif; ?>">
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>T.K. <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text"  id="companypostcode" name="companypostcode" placeholder="Τ.Κ." value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companypostcode'])): ?><?php echo e($pay_bill_data['companypostcode']); ?><?php endif; ?>">
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>Πόλη<span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text"id="companycity" name="companycity" placeholder="Πόλη" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companycity'])): ?><?php echo e($pay_bill_data['companycity']); ?><?php endif; ?>"required />
                                    </div>
                                 </div>
                                 <div class="col6 col-sm-12">
                                    <label>Email αποστολής τιμολογίου <span>*</span></label>
                                    <div class="input-safe-wrapper">
                                          <input class="required" type="text"id="companyemail" name="companyemail" placeholder="Email αποστολής τιμολογίου" value="<?php if(isset($pay_bill_data) && isset($pay_bill_data['companyemail'])): ?><?php echo e($pay_bill_data['companyemail']); ?><?php endif; ?>"required />
                                    </div>
                                 </div>
               ...
               <div class="col12 col-sm-12">
                  ...
                  <div class="form-wrapper">
                     <form method="post" id='sbt-pay' action="/pay-sbt">
                        ...
                        <?php if(isset($paywithstripe) && $paywithstripe == 1 && count($coupons) > 0): ?>
                           <?php if($item->options->has('type')): ?>
                        ...
                        <div class="row">
                           <?php if(isset($paywithstripe) && $paywithstripe == 1): ?>
                              <?php echo $__env->make('theme.cart.stripe-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                           ...
                           <div class="col12 hidden-fields-actions installments-fields">
                              ...
                              <div class="custom-radio-wrapper small-radio">
                                 <div class="custom-radio-box children-radio">
                                    ...
                                    <div class="label-wrapper">
                                       <label for="radio-installment-full-control">Payment in full <span>€<?php echo e($instOne); ?></span>.</label>
                                    </div>
                                 </div>
                                 <div class="custom-radio-box children-radio">
                                    <div class="crb-wrapper">
                                    ...
                                    <div class="label-wrapper">
                                       <label for="radio-installment-2-control">2 installments: <span>2x €<?php echo e($instTwo); ?></span>.</label>
                                 ...
                                 <div class="custom-radio-box children-radio">
                                    ...
                                    <div class="label-wrapper">
                                       <label for="radio-installment-3-control">3 installments: <span>3x €<?php echo e($instThree); ?></span>.</label>
                              ...
                              <input type="hidden" id="payment_method_id" name="payment_method_id" value="<?php echo e($pay_methods['id']); ?>">
...
<?php if(isset($paywithstripe) && $paywithstripe == 1 && Auth::check()): ?>
<script>
    var count = 0;
    ...
    $(document).on('click', '#addCard', function(e){
      ...
      $('.msg_save_card').remove();
       ...
       .attr('id', 'stripe-form')
        ...
        //$('#card-button').attr('data-secret', '<?php echo e(Auth::user()->createSetupIntent()->client_secret); ?>')
...
<?php if(request()->has('reg') &&request()->get('reg') == 10 ): ?>
<script type="text/javascript">
   $( document ).ready(function() {
...
$( document ).ready(function() {
   ...
   <?php if((isset($info) && isset($info['success'])) && $info['success'] !== true && isset($item)): ?>
   ...
   if(<?php echo Cart::instance('default')->subtotal() ?> > 0){
      ...
      fbq('track', 'AddToCart', {
         ...
         content_ids: ['<?php echo e($eventId); ?>'],
...
<?php if(isset($info) && isset($info['message']) && $info['message'] != ''): ?>
<?php if($info['statusClass'] == 'success'): ?>
<?php if(isset($tigran) && isset($tigran['evid']) && isset($tigran['price'])): ?>
<script type="text/javascript">

   setTimeout(function(){
   	fbq('track', 'Purchase', {
   value: '<?php echo e($tigran['price']); ?>',
   currency: 'EUR',
   content_ids: '<?php echo e($tigran['evid']); ?>',
   });
   gtag('event', 'conversion', {
   'send_to': 'AW-859787100/L83oCJ_NhKMBENye_ZkD',
   'value': '<?php echo e($tigran['price']); ?>',
   'currency': 'EUR',
   'transaction_id': '<?php echo e($tigran['transid']); ?>'
   });
  ...
  'items': [
    {
      'id': '<?php echo e($tigran['evid']); ?>',
      'name': '<?php echo e($tigran['evid']); ?>'
    }
  ]
});
   }, 1000);
...
<script>
   ...
   $(document).ready(function() {
      ...
      <?php if("<?php echo e(old('countryCode')); ?>"): ?>
         ...
         $("#selectCountry").val("<?php echo e(old('countryCode')); ?>").change();
      ...
      <?php if(isset($totalitems)): ?>
         ...
         <?php for($i =0; $i < $totalitems; $i++): ?>
            ...
            <?php if(isset($pay_seats_data) && !isset($pay_seats_data['countryCodes'][$i]) && $i == 0): ?>

               $("#selectCountry"+"<?php echo e($i); ?>").val("<?php echo e($cur_user->country_code); ?>").change();

            <?php elseif( isset($pay_seats_data) && isset($pay_seats_data['countryCodes'][$i]) ): ?>

               $("#selectCountry"+"<?php echo e($i); ?>").val("<?php echo e(old('countryCodes[$i]',$pay_seats_data['countryCodes'][$i])); ?>").change();
   ...
   <?php if($item->options->has('type')): ?>
      ...
      <script>
         ...
         $('.coupon-submit').click(function(){
            ...
            $.ajax({ url: '/cart/checkCoupon/<?php echo e($eventId); ?>', type: "post",
            data:{'coupon': $("#coupon").val()} ,
            success: function(data) {
               if(data['success']){
                  $('.ticket-coupon').text('€' + "<?php echo e($item->qty); ?>" * data['new_price']);
                  $('.ticket-coupon-inst2').text('€' + "<?php echo e($item->qty); ?>" * data['newPriceInt2']);
                  $('.ticket-coupon-inst3').text('€' + "<?php echo e($item->qty); ?>" * data['newPriceInt3']);

                  let p = `<p><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-success-alert.svg')); ?>" alt="Info Alert">` + data['message']+ `</p>`
                  ...
                  let p = `<p><img src="<?php echo e(cdn('/theme/assets/images/icons/alert-icons/icon-error-alert.svg')); ?>" alt="Info Alert">` + data['message']+ `</p>`
...
<?php echo $__env->make('theme.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/theme/cart/cart.blade.php ENDPATH**/ ?>