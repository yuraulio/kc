                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Exams')); ?></h3>
                            </div>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Model\User::class)): ?>
                                <div class="col-4 text-right">
                                    <a href="<?php echo e(route('exams.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Exam')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive py-4">
                        <table class="table align-items-center table-flush"  id="datatable-basic7">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $exams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('exams.edit', $exam->id)); ?>"><?php echo e($exam->exam_name); ?> </a></td>
                                        <td><?php echo e(date_format($exam->created_at, 'Y-m-d' )); ?></td>
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" href="<?php echo e(route('exams.edit', $exam->id)); ?>"><?php echo e(__('Edit')); ?></a>
                                                </div>
                                            </div>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/exams/index.blade.php ENDPATH**/ ?>