         ...
         <div class="your-selection">
            <div class="item">
               <div class="remove-area">
                  <a class="btn-remove1" href="myaccount/"><img src="<?php echo e(cdn('/theme/assets/images/icons/icon-delete.svg')); ?>" class="replace-with-svg" alt=""/><span>Remove</span></a>
               </div>
               <div class="left">
                  <h3> <?php echo e($event->title); ?> </h3>
                  <div class="bottom">
                     <?php if(isset($city)): ?><div class="location"><img src="<?php echo e(cdn('/theme/assets/images/icons/marker.svg')); ?>" alt=""><?php echo e($city); ?></div><?php endif; ?>
                     
                     <?php if(isset($duration)): ?><div class="expire-date"><img src="<?php echo e(cdn('/theme/assets/images/icons/Start-Finish.svg')); ?>" alt=""><?php echo e($duration); ?></div><?php endif; ?>
               ...
               <div class="right">
                  <ul class="checkout-infos">
                     <li>
                        ...
                        <span class="value"><?php echo e($plan->name); ?></span>
                     </li>
                     <li>
                        <span class="label">Billing period:</span>

                        <span class="value ticket-coupon">
                        <?php echo e($plan->period()); ?>
                     ...
                     <li class="total-amount">
                        ...
                        <span class="value ticket-coupon">€<?php echo e($plan->cost); ?></span>
                     </li>
                  </ul>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col8 col-sm-12">
                  ...
                  <div class="form-wrapper">
                     <form method="post" id='user-info' action="/myaccount/subscription/store/<?php echo e($event->title); ?>/<?php echo e($plan->name); ?>" class="small-form">
         ...
         <div class="checkout-wrapper">
            <div class="row">
               <div class="col8 col-sm-12">
                  <h2>Billing</h2>
                  <div class="form-wrapper">
                     <form method="post" id="billing-setting" action="/myaccount/subscription/store/<?php echo e($event->title); ?>/<?php echo e($plan->name); ?>" class="small-form">
                        <?php echo e(csrf_field()); ?>
                        ...
                        <div class="row">
                           ...
                           <div class="col12 receipt-fields hidden-fields-actions" style="display:block">
                              ...
                              <input style="display:none" name="event" value="<?php echo e($event->id); ?>">
         ...
         <div class="checkout-wrapper">
            <div class="row">
               <div class="col12 col-sm-12">
                  <h2>Payment</h2>
                  <div class="form-wrapper">
                     <form method="post" id='sbt-pay' action="/myaccount/subscription/store/<?php echo e($event->title); ?>/<?php echo e($plan->name); ?>">
                        <?php echo e(csrf_field()); ?>
                        ...
                        <div class="row">
                              ...
                              <?php echo $__env->make('theme.cart.stripe-suscription-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('theme.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/theme/cart/subscription-form.blade.php ENDPATH**/ ?>