<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('social.index')); ?>"><?php echo e(__('Social Management')); ?></a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Social')); ?></h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('social.create', $var)); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Social')); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive py-4">
                        <table class="table align-items-center table-flush"  id="datatable-basic103">
                            ...
                            <tbody>
                                <?php //dd($social_media); ?>
                                <?php $__currentLoopData = $social_media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                                    $arr['social'] = $key;
                                                    ?>
                                    <tr>
                                        <td><a class="dropdown-item" href="<?php echo e(route('social.edit', $arr)); ?>"><?php echo e($item['title']); ?></a></td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <a class="dropdown-item" href="<?php echo e(route('social.edit', $arr)); ?>"><?php echo e(__('Edit')); ?></a>
...
<?php echo $__env->make('layouts.app', [
    'title' => __('Social Management'),
    'parentSection' => 'laravel',
    'elementName' => 'social-management'
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/social/index.blade.php ENDPATH**/ ?>