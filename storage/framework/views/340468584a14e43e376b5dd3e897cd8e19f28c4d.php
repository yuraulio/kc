...
<nav class="navbar navbar-top navbar-expand border-bottom <?php echo e($navClass ?? 'navbar-dark bg-primary'); ?>">
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <!-- Search form -->
            <form class="navbar-search <?php echo e($searchClass ?? 'navbar-search-light'); ?> form-inline mr-sm-3 search" id="navbar-search-main">
                <div class="form-group mb-0 search">
                    <div class="input-group input-group-alternative input-group-merge">
                        <div class="input-group-prepend">
                            <span class="input-group-text"><i class="fas fa-search"></i></span>
                        </div>
                        <input id="search-user" class="form-control" placeholder="<?php echo e(__('Search')); ?>" type="text">
                    </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media align-items-center">
                            ...
                            <?php if(isset(auth()->user()->image) && auth()->user()->image['name'] != ''): ?>
                                <?php
                                ...
                                ?>
                                    <img src="<?php echo e($path); ?>" onerror="this.src='<?php echo e(cdn('/theme/assets/images/icons/user-profile-placeholder-image.png')); ?>'" class="rounded-circle">
                                <?php else: ?>
                                <img src="" alt="<?php echo e(auth()->user()->firstname); ?>" onerror="this.src='<?php echo e(cdn('/theme/assets/images/icons/user-profile-placeholder-image.png')); ?>'" class="rounded-circle">
                                <?php endif; ?>

                            </span>
                            <div class="media-body ml-2 d-none d-lg-block">
                                <span class="mb-0 text-sm  font-weight-bold"><?php echo e(auth()->user()->firstname); ?></span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <!-- <a href="javascript:void(0)" id="update-btn" class="dropdown-item">
                            ...
                            <span><?php echo e(__('Update Dropbox')); ?></span>
                        </a> -->
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\kcversion8\resources\views/layouts/navbars/navs/auth.blade.php ENDPATH**/ ?>