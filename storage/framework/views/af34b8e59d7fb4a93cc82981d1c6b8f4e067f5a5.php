...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item"><a href="#"><?php echo e(__('options')); ?></a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Options')); ?></h3>
                                <p class="text-sm mb-0">
                                    <?php echo e(__('This is an example of Options management. This is a minimal setup in order to get started fast.')); ?>
                        ...
                        <table class="table table-flush"  id="datatable-basic15">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('option.edit', $option->id)); ?>"> <?php echo e($option->name); ?> </a></td>
                                       
                                        <td><?php echo e($option->created_at->format('d/m/Y H:i')); ?></td>
                                            ...
                                            <?php //dd($user); ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('option.edit', $option->id)); ?>"><?php echo e(__('Edit')); ?></a>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/options/options_list.blade.php ENDPATH**/ ?>