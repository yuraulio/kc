            ...
            <div class="tab-controls">
               <div class="container">
                  ...
                  <ul class="clearfix tab-controls-list">
                     ...
                     <?php if(count($testimonials) > 0): ?><li><a href="#testimonials">Testimonials</a></li><?php endif; ?>
                     <?php if(count($faqs) > 0): ?><li><a href="#faq">FAQ</a></li><?php endif; ?>
                     <?php elseif($estatus == 3 || $estatus == 1 ): ?>
                     <li><a href="#topics">Topics</a></li>
                     <li><a href="#instructors">Instructors</a></li>
                     <?php endif; ?>
                  </ul>
                  <?php if($is_event_paid==0 && !Auth::user()): ?>
                  <a href="<?php echo e(route('cart.add-item', [ $event->id,'free', 8 ])); ?>" class="btn btn--lg btn--primary hidden-sm go-to-href">ENROLL FOR FREE</a>
                  <?php elseif($is_event_paid==0 && Auth::user()): ?>
                  <a href="<?php echo e(route('enrollForFree',  $event->id)); ?>" class="btn btn--lg btn--primary hidden-sm go-to-href">ENROLL FOR FREE</a>
                  <?php endif; ?>
                                 ...
                                 <?php $__currentLoopData = $topic['lessons']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lkey => $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="topic-wrapper-big">
                                       <div class="topic-title-meta">
                                          <h4 class="<?php if(isset($lesson['bold']) && $lesson['bold']): ?> bold-topic <?php endif; ?>"><?php echo $lesson['title']; ?></h4>


                                          <div class="topic-meta">
                                             <?php if(isset($lesson['type']) && $lesson['type']): ?><div class="category"><?php echo e($lesson['type']); ?></div><?php endif; ?>

                                             <span class="meta-item duration"><img src="<?php echo e(cdn('/theme/assets/images/icons/Times.svg')); ?>" width="12" alt="" /><?php echo e($lesson['vimeo_duration']); ?></span>
...
<?php echo $__env->make('theme.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/theme/event/elearning_free.blade.php ENDPATH**/ ?>