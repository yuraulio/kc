...
function finishExam() {
    ...
    if (r == true) {
        ...
        var startTime = localStorage.getItem("examStart<?php echo $exam->id;?>-<?php echo e($user_id); ?>");
        jQuery.ajaxSetup({
            headers: {
        ...
        jQuery.ajax({
        method: "POST",
        url: "<?php echo e(route('save-data')); ?>",
        data: { examJson: retrievedObject, start_time: startTime, student_id: <?php echo e($user_id); ?>, exam_id: <?php echo e($exam->id); ?> },
        success: function() {
          //  alert("Exam Completed Successfully");
            <?php if($exam->indicate_crt_incrt_answers || $exam->display_crt_answers) { 
            ?>
                window.location = "<?php echo e(route('exam-results', [$exam->id])); ?>";
            <?php
            }
            else
            {
...
function forceFinish() {
    ...
    success: function() {
       // alert("Time Over. Exam Completed Successfully");
            <?php if($exam->indicate_crt_incrt_answers || $exam->display_crt_answers) { 
            ?>
            setTimeout(function(){  window.location = "<?php echo e(route('exam-results', [$exam->id])); ?>"; }, 50000);
...
function updateStats() {
    ...
    if (typeof(Storage) !== "undefined") {
        localStorage.setItem("examStorage<?php echo $exam->id;?>-<?php echo e($user_id); ?>", window.examVar);
    }
...
function initializeView() {
    ...
    var eJson = JSON.parse( window.examVar );      
    window.startTime = localStorage.getItem("examStart<?php echo $exam->id;?>-<?php echo e($user_id); ?>");
...
if (typeof(Storage) !== "undefined") {
    ...
    if (localStorage.getItem("examStorage<?php echo $exam->id;?>-<?php echo e($user_id); ?>") === null) {
        localStorage.setItem("examStorage<?php echo $exam->id;?>-<?php echo e($user_id); ?>", examJson);
        localStorage.setItem("examStart<?php echo $exam->id;?>-<?php echo e($user_id); ?>", startTime);
        window.examVar = examJson;
        setTimeout(function(){ jQuery("#overlay-loading").hide(); }, 5000);      
        <?php if($redata!=0) { ?>
            localStorage.setItem("examStart<?php echo $exam->id;?>-<?php echo e($user_id); ?>", '<?php echo e($redata); ?>');
            window.examVar = localStorage.getItem("examStorage<?php echo $exam->id;?>-<?php echo e($user_id); ?>");
        ...
        <?php } 
            ...
            ?>
            jQuery(document).ready(function(){
                setTimeout(function(){ intilizetimer(<?php echo e($hours); ?>,<?php echo e($minutes); ?>,<?php echo e($seconds); ?>); }, 1500); 
            });
        <?php
        }
        ?>      
...
">
        <div class="col-md-12">
            <h5><?php echo $exam->end_of_time_text; ?></h5>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body" style="padding:0">
                    ...
                    <input type="hidden" name="time_spent" id="time_spent" value="0">
                                 ...
                                 <?php $__currentLoopData = $ex_contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam_content_id => $ex_content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php $last_id = $exam_content_id; ?>
                                    <div class="question_div <?php echo e($exam->id); ?>" name="question[<?php echo e($exam_content_id); ?>]" id="<?php echo e($exam_content_id); ?>" style="display:none;" value="0">
                                        <div style="padding: .75rem 1.25rem;
    margin-bottom: 0;
    background-color: rgba(0,0,0,.03);
    border-bottom: 1px solid rgba(0,0,0,.125);"><h4><?php echo $ex_content['question_title']; ?></h4>
        ...
        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="timerdiv" class="countdown-styled ">
                                ...
                                <span id="mins"><?php if($minutes<10){ echo '0'; }?><?php echo e($minutes); ?></span> : 
            ...
            <?php if(Request::segment(1) == 'exam-start'): ?>
                        ...
                        <div class="col-md-12">
                            <ul class="question-palette" id="pallete_list"> 
                                ...
                                foreach($ex_contents as $exam_content_id => $ex_content) { 
                                    ...
                                    ?>
                                    <li class="palette pallete-elements not-visited <?php echo e($exam_content_id); ?>" onclick="showSpecificQuestion(<?php echo e($exam_content_id); ?>, 1);">
...
<script>
    ...
    jQuery( document ).ready(function() {
        ...
        setInterval(function(){ 
            ...
            var retrievedObject = localStorage.getItem('examStorage<?php echo $exam->id;?>-<?php echo e($user_id); ?>');
            var startTime = localStorage.getItem("examStart<?php echo $exam->id;?>-<?php echo e($user_id); ?>");
            jQuery.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')
            ...
            if(window.actQues==<?php echo e($last_id); ?>) {
                    var eJson = JSON.parse( window.examVar );  
                    list = $('#'+window.actQues + ' input ');
                    var currQues = window.actQues;
                    var lastQues = 0;
            ...
            if(window.exam_finish==0) {
                jQuery.ajax({
                method: "POST",
                url: "<?php echo e(route('sync-data')); ?>",
                data: { examJson: retrievedObject, start_time: startTime, student_id: <?php echo e($user_id); ?>, exam_id: <?php echo e($exam->id); ?> },
                success: function() {
                }
                });          
...
<?php echo $__env->make('exams.exams-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/exams/exam_start.blade.php ENDPATH**/ ?>