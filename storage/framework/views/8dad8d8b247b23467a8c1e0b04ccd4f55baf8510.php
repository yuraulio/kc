...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('payments.index')); ?>"><?php echo e(__('Payments Methods Management')); ?></a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Payments Methods')); ?></h3>
                            </div>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Model\User::class)): ?>
                                <div class="col-4 text-right">
                                    <a href="<?php echo e(route('payments.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Payment Method')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center table-flush"  id="d17">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col"><?php echo e(__('Options')); ?></th>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($method->method_slug); ?>

                                        </td>
                                        <td>
                                            <?php echo e($method->status); ?>
					                        ...
					                        <td class="">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('payments.edit', $method->id)); ?>"><?php echo e(__('Edit')); ?></a>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/payment_methods/index.blade.php ENDPATH**/ ?>