<div class="row align-items-center">
    <div class="col-8">
        <h3 class="mb-0"><?php echo e(__('Videos')); ?></h3>
        <p class="text-sm mb-0">
            <?php echo e(__('This is an example of Video management.')); ?>

        </p>
    </div>
    <div class="col-4 text-right">
        <button data-toggle="modal" data-target="#videoModal" class="btn btn-sm btn-primary"><?php echo e(__('Assign video')); ?></button>
    </div>
</div>
<div class="table-responsive py-4">
    <table class="table align-items-center table-flush video-table" id="datatable-basic-video">
        <thead class="thead-light">
            <tr>
                <th scope="col"><?php echo e(__('Title')); ?></th>                <th scope="col"></th>
            </tr>
        </thead>
        <?php //dd($model->videos); ?>
        <tbody class="video-body summaries-order">
 
        <?php if($model->sectionVideos): ?>
            <?php $__currentLoopData = $model->sectionVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td id="title-<?php echo e($video->id); ?>" data-id="<?php echo e($video->id); ?>" class="video-list"><a class="edit-btn" href="#"> <?php echo e($video->title); ?> </a></td>
    ...
    <div class="modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-event-id="<?php echo e($model->id); ?>" id="video_save_btn" class="btn btn-primary">Save changes</button>
            </div>
...
<script>
    $(document).on('click', '#video_save_btn',function(e) {
        ...
        $.ajax({
            ...
            type: 'post',
            url: '<?php echo e(route("video.store_event")); ?>',
...
<?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/videos/event/index.blade.php ENDPATH**/ ?>