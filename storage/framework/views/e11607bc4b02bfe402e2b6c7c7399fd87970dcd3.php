                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Deliveries')); ?></h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('delivery.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Delivery')); ?></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive py-4">
                        <table class="table align-items-center table-flush"  id="datatable-basic4">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $deliveries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $delivery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('delivery.edit', $delivery)); ?>"><?php echo e($delivery->name); ?></a></td>
                                        <td><?php echo e(date_format($delivery->created_at, 'Y-m-d' )); ?></td>
					                        ...
					                        <td class="text-right">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <a class="dropdown-item" href="<?php echo e(route('delivery.edit', $delivery)); ?>"><?php echo e(__('Edit')); ?></a>
                                                        </div>
                                                    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
         var table = $('#datatable-basic4').DataTable({
        language: {
            paginate: {
            next: '&#187;', // or '→'
            previous: '&#171;' // or '←'
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/delivery/index.blade.php ENDPATH**/ ?>