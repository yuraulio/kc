...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('layouts.headers.auth'); ?>
        <?php $__env->startComponent('layouts.headers.breadcrumbs'); ?>
            ...
            <li class="breadcrumb-item"><a href="#"><?php echo e(__('Coupon Management')); ?></a></li>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Coupon Management')); ?></h3>
                            </div>

                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('coupon.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add coupon')); ?></a>
                            </div>
                        ...
                        <table class="table table-flush"  id="datatable-basic3">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $coupons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><a href="<?php echo e(route('coupon.edit', $coupon->id)); ?>"> <?php echo e($coupon->code_coupon); ?> </a></td>
                                        <td><?php echo e($coupon->status); ?></td>
                                        <td><?php echo e($coupon->used); ?></td>
                                        <td><?php echo e($coupon->created_at->format('d/m/Y H:i')); ?></td>
                                            ...
                                            <?php //dd($user); ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('coupon.edit', $coupon->id)); ?>"><?php echo e(__('Edit')); ?></a>
...
], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kcversion8\resources\views/admin/coupon/coupons_list.blade.php ENDPATH**/ ?>