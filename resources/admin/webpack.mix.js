...
mix.combine(third_party_js, folder.dist_assets + "js/vendor.js").minify(
...
var third_party_assets = {
    css_js: [
        ...
        {
            name: "autonumeric",
            assets: ["./node_modules/autonumeric/dist/autoNumeric.min.js"],
        },
        {
        ...
        {
            name: "footable",
            assets: ["./node_modules/footable/dist/footable.all.min.js"],
        },
        {
            name: "gmaps",
        ...
        },
        {
            ...
            assets: ["./node_modules/jquery-tabledit/jquery.tabledit.min.js"],
        },
        {
        ...
        {
            name: "minimist",
            assets: ["./node_modules/minimist/index.js"],
        },
        {
        ...
        {
            name: "morris.js06",
            assets: ["./node_modules/morris.js06/dist/morris.min.js"],
        },
        {
            name: "multiselect",
            assets: [
...
[
    "scss",
    "scss/config/creative",
    "scss/config/default",
    "scss/config/material",
    "scss/config/modern",
    "scss/config/purple",
    "scss/config/saas",
].forEach((scss_disc) => {
    getFiles(folder.src + scss_disc).forEach(function (filepath) {
        if (!filepath.startsWith("_")) {
            var fileName =
                filepath.substring(0, filepath.lastIndexOf(".")) || filepath;
            var css_disc = scss_disc
                .replace("scss", "css")
                .replace("/config", "");
            var demo = scss_disc.replace("scss", "").replace("/config", "");
