...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('events.index') }}">{{ __('Benefits Management') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('Add Benefit') }}</li>
        @endcomponent
    @endcomponent
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('benefit.store') }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('priority') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="numeric" name="priority" id="input-priority" class="form-control{{ $errors->has('priority') ? ' is-invalid' : '' }}" placeholder="{{ __('Priority') }}" value="{{ old('priority') }}" autofocus>
