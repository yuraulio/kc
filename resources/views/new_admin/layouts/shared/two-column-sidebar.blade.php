        ...
        <div class="sidebar-content">
            <div class="sidebar-icon-menu h-100" data-simplebar>
                ...
                <a href="{{route('any', 'index')}}" class="logo">
                    <span>
                        <img src="{{asset('admin_assets/images/logo-sm-light.png')}}" alt="" height="28">
                    </span>
                </a>
                <nav class="nav flex-column" id="two-col-sidenav-main">
                    ...
                    <a class="nav-link" href="{{route('any', 'widgets')}}" title="Widgets">
                ...
                <div id="two-col-menu" class="h-100" data-simplebar>
                    <div class="twocolumn-menu-item d-block" id="dashboard">
                        <div class="title-box">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('any', 'index')}}">Dashboard 1</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="twocolumn-menu-item" id="layouts">
                        <div class="title-box">
                            ...
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('second', ['layouts', 'vertical'])}}">Vertical</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('second', ['layouts', 'horizontal'])}}">Horizontal</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('second', ['layouts', 'detached'])}}">Detached</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('second', ['layouts', 'two-tone-icons'])}}">Two Tones Icons</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('second', ['layouts', 'preloader'])}}">Preloader</a>
                                </li>
                            </ul>
                        </div>
                    </div>
