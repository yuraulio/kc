                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            ...
                            <a href="{{route('second', ['apps', 'calendar'])}}" class="dropdown-item"><i class="fe-calendar me-1"></i> Calendar</a>
                            <a href="{{route('second', ['apps', 'chat'])}}" class="dropdown-item"><i class="fe-message-square me-1"></i> Chat</a>
                            <div class="dropdown">
                            ...
                            <a href="{{route('second', ['apps', 'social-feed'])}}" class="dropdown-item"><i class="fe-rss me-1"></i> Social Feed</a>
                            <a href="{{route('second', ['apps', 'companies'])}}" class="dropdown-item"><i class="fe-activity me-1"></i> Companies</a>
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-tickets" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <a href="{{route('second', ['apps', 'file-manager'])}}" class="dropdown-item"><i class="fe-folder-plus me-1"></i> File Manager</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            ...
                            <a href="{{route('any', 'widgets')}}" class="dropdown-item"><i class="fe-gift me-1"></i> Widgets</a>
                            <div class="dropdown">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layout">
                            <a href="{{route('second', ['layouts', 'vertical'])}}" class="dropdown-item">Vertical</a>
                            <a href="{{route('second', ['layouts', 'horizontal'])}}" class="dropdown-item">Horizontal</a>
                            <a href="{{route('second', ['layouts', 'detached'])}}" class="dropdown-item">Detached</a>
                            <a href="{{route('any', 'index')}}" class="dropdown-item">Two Column Menu</a>
                            <a href="{{route('second', ['layouts', 'two-tone-icons'])}}" class="dropdown-item">Two Tones Icons</a>
                            <a href="{{route('second', ['layouts', 'preloader'])}}" class="dropdown-item">Preloader</a>
                        </div>
                    </li>
                </ul> <!-- end navbar-->
            </div> <!-- end .collapsed-->
