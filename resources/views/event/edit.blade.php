                                    ...
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        ...
                                        <div class="row course-certification-wrapper">
                                            ...
                                            <div class="form-group col-12 course-certification-visible-wrapper {{ isset($info['certificate']['has_certificate']) && $info['certificate']['has_certificate'] ? '' : 'd-none'  }}">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-lg-4 form-group">
                                                        ...
                                                        <!-- anto's editor -->
                                                        <input class="hidden" id="input-certificate_text_hidden" name="course[{{'certificate'}}][{{'text'}}]" value="{{ old('certificate-text', (isset($info['certificate']['text']) && $info['certificate']['text'] != null) ? $info['certificate']['text'] : '' ) }}"/>
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <label class="custom-toggle enroll-toggle visible">
                                                    <input name="course[{{'certificate'}}][{{'certification_exam'}}]" id="certification-after-exam-toggle" {{isset($info['certificate']['has_certificate_exam']) && $info['certificate']['has_certificate_exam'] ? 'checked' : '' }} type="checkbox">
                                                    <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Yes"></span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 completion-text form-group{{ $errors->has('fb_') ? ' has-danger' : '' }}">
                                                        ...
                                                        <!-- anto's editor -->
                                                        <input class="hidden" id="input-certificate_completion_hidden" name="course[{{'certificate'}}][{{'completion_text'}}]" value="{{ old('certificate_title', (isset($info['certificate']['messages']['completion']) && $info['certificate']['messages']['completion'] != null) ? $info['certificate']['messages']['completion'] : '') }}"/>
