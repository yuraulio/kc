            ...
            <div class="col">
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            @can('create', App\Model\User::class)
                                <div class="col-4 text-right">
                                    <a href="{{ route('faqs.create_category') }}" class="btn btn-sm btn-primary">{{ __('Add Faqs Category') }}</a>
                                </div>
                            @endcan
                        </div>
                    </div>
                    ...
                    <div class="table-responsive py-4">
                        <table class="table align-items-center table-flush"  id="datatable-basic28">
					                        ...
					                        <td class="text-right">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item" href="{{ route('faqs.edit_category', $category) }}">{{ __('Edit') }}</a>
                                                        {{--<form action="{{ route('faqs.destroy', $category) }}" method="post">
                                                            @csrf
                                                            @method('delete')
...
@push('js')
    ...
    var table = $('#datatable-basic28').DataTable({
        language: {
            paginate: {
            next: '&#187;', // or '→'
            previous: '&#171;' // or '←'
