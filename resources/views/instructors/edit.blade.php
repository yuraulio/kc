                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="tabs-icons-text-2" role="tabpanel" aria-labelledby="tabs-icons-text-2-tab">
                                @include('admin.upload.upload', ['event' => ( isset($instructor) && $instructor->medias != null) ? $instructor->medias : null,'image_version' => 'instructors-testimonial', 'versions' => ['instructors-testimonials', 'instructors-small']])
