...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item"><a href="{{ route('section.index') }}">{{ __('Sections Management') }}</a></li>
                        ...
                        <div class="row align-items-center">
                            ...
                            @can('create', App\Model\User::class)
                                <div class="col-4 text-right">
                                    <a href="{{ route('section.create') }}" class="btn btn-sm btn-primary">{{ __('Add Section') }}</a>
                                </div>
                            @endcan
                        </div>
                    </div>
