        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm">
                    <span>CLASS: {{ $total_users_inclass }}</span>
                    <span class="ml-3">VIDEO: {{ $total_users_elearning }}</span>
                </p>
    ...
    <div class="card-body col-xl-3 col-md-6 total-sales">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm">
                    <span>CLASS: &euro;{{ number_format($paid_installments_inclass,2,'.','.') }}</span>
                    <span class="ml-3">VIDEO: &euro;{{ number_format($paid_installments_elearning,2,'.','.') }}</span>
                </p>
                <p class="mb-0 text-sm">
    ...
    <div class="card-body col-xl-3 col-md-6 total-sales">
        <div class="card">
            <div class="card-body">
                ...
                <p class="mt-3 mb-0 text-sm">
                    <span>EARLY: &euro;{{ number_format($income['early'],2,'.','.') }}</span>
                    <span class="ml-3">SPECIAL: &euro;{{ number_format($income['special'],2,'.','.') }}</span>
                    <span class="ml-3">REGULAR: &euro;{{ number_format($income['regular'],2,'.','.') }}</span>
                </p>
                <p class="mb-0 text-sm">
