...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item active" aria-current="type">{{ __('Add Venues') }}</li>
        @endcomponent
    @endcomponent
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form method="post" action="{{ route('venue.store_main') }}" autocomplete="off"
