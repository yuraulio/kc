...
@section('content')
    @component('layouts.headers.auth')
        @component('layouts.headers.breadcrumbs')
            ...
            <li class="breadcrumb-item active" aria-current="type">{{ __('Edit Venue') }}</li>
        @endcomponent
    @endcomponent
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('venue.index_main') }}" class="btn btn-sm btn-primary">{{ __('Back to list') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                    <form method="post" action="{{ route('venue.update', $venue) }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('direction_description') ? ' has-danger' : '' }}">
                                    ...
                                    <!-- anto's editor -->
                                    <input class="hidden" name="direction_description" value="{{ old('direction_description', $venue->direction_description) }}"/>
                                    <?php $data = old('direction_description', $venue->direction_description); ?>
