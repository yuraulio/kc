                            ...
                            <div class ="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="checkbox" name="indicate_crt_incrt_answers" class="custom-control-input" id="indicate_crt_incrt_answers">
                                    ...
                                    <div class="form-group{{ $errors->has('random_questions') ? ' has-danger' : '' }}">
                                        <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="random_questions" class="custom-control-input" id="random_questions">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group{{ $errors->has('display_crt_answers') ? ' has-danger' : '' }}">
                                        <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="display_crt_answers" class="custom-control-input" id="display_crt_answers">
                                    ...
                                    <div class="form-group{{ $errors->has('random_answers') ? ' has-danger' : '' }}">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="random_answers" class="custom-control-input" id="random_answers">
                                ...
                                <div class="form-group{{ $errors->has('intro_text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="intro_text" id="input-intro_text"  class="ckeditor form-control{{ $errors->has('intro_text') ? ' is-invalid' : '' }}" placeholder="{{ __('Replace this text as exam introduction text') }}"  required autofocus></textarea>
                                ...
                                <div class="form-group{{ $errors->has('end_of_time_text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="end_of_time_text" id="input-end_of_time_text"  class="ckeditor form-control{{ $errors->has('end_of_time_text') ? ' is-invalid' : '' }}" placeholder="{{ __('Replace this text as exam end of time text') }}"  required autofocus></textarea>
                                ...
                                <div class="form-group{{ $errors->has('success_text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="success_text" id="input-success_text"  class="ckeditor form-control{{ $errors->has('success_text') ? ' is-invalid' : '' }}" placeholder="{{ __('Replace this text as exam success text') }}"  required autofocus></textarea>
                                ...
                                <div class="form-group{{ $errors->has('failure_text') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="failure_text" id="input-failure_text"  class="ckeditor form-control{{ $errors->has('failure_text') ? ' is-invalid' : '' }}" placeholder="{{ __('Replace this text as exam success text') }}"  required autofocus></textarea>
