                        ...
                        <form method="post" action="{{ route('lessons.update', $lesson) }}" autocomplete="off"
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('summary') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="summary" id="input-summary" class="form-control{{ $errors->has('summary') ? ' is-invalid' : '' }}" placeholder="{{ __('Summary') }}" value="{{ old('summary', $lesson->summary) }}" autofocus>
