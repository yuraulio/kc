...
function contentTpl(row) {
    ...
    html += '<div class="gallery-photo-holder">';
    html += '<a href="'+row.slug+'" title="'+$.trim(row.title)+'" target="'+row.target+'">';
    html += '<img class="img-responsive gallery-photo-image" alt="'+$.trim(row.title)+'" src="'+row.src+'" />';
    html += '</a>';
    html += '<h1 class="gallery-photo-post-title">';
    html += '<a href="'+row.slug+'" title="'+$.trim(row.title)+'" target="'+row.target+'">';
    html += $.trim(row.title);
    html += '</a>';
    html += '</h1>';
