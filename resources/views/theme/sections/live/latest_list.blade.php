            ...
            <div class="row">
                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="posts-category-sections">
                        <div class="home-category-heading home-category-heading-generic live-section-color">
                            <div class="categ-text">
                                <i class="fa fa-rss"></i> ΡΟΗ ΕΙΔΗΣΕΩΝ
                            </div>
                        </div>

                        <div class="row" id="appendNewContent" data-dp-take="{{ $take }}" data-dp-total="{{ $live_dets['total'] }}" data-dp-skip="{{ $list->count() }}" data-dp-updated-pivot-time="{{ $updated_pivot_time }}">
                        @if (!empty($list))
...
@include('theme.sections.live.latest_list_load_more')
@endsection
