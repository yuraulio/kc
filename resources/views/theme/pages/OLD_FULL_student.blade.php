            ...
            <div class="row row-offcanvas row-offcanvas-left" >
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 side sidebar-offcanvas" id="leftCol">
                    <div class="about-sidebar clearfix">
                        ...
                        <li class="active ">
                            <a href="#accdet" title="My profile">My profile</a>
                        </li>
                        <li class="">
                            <a href="#accdownloads" title="My events">My events</a>
                        </li>
                        <li class="">
                            <a href="#billinfle" title="">My billing info</a>
                        </li>
                        <li class="disabled">
                            <a href="/student" title="My assessments">My assessments</a>
                        </li>
                        <li class="disabled">
                            <a href="/student" title="My exams">My exams</a>
                        </li>
                        ...
                        <div id="student-billing-view-mode" class="col-lg-6 col-md-7 col-sm-12 col-xs-12">
                            ...
                            <?php
                                $hone = [
                                        ...
                                        'billemail' => 'Receipt email',
                                        'billmobile' => 'Receipt mobile',
