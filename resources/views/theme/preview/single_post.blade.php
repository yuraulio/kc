    ...
    <div id="single_post">
                ...
                <div class="col-lg-9 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="post-social-line clearfix">
                        ...
                        <div class="post-social">
                            <div class="social_icon social_icon_fb"><a target="_blank" href="http://www.facebook.com/sharer.php?u=http://www.darkpony.com" onclick="javascript:window.open(this.href,
          '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-facebook"> </i> facebook
                                </a>
                            </div>
                            <div class="social_icon social_icon_tw"><a target="_blank" href="http://twitter.com/share?text=Darkpony&amp;url=http://wwww.darkpony.com" onclick="javascript:window.open(this.href,
      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-twitter"> </i> twitter
                            ...
                            <div class="social_icon social_icon_gp">
                                <a target="_blank" href="https://plus.google.com/share?url=http://www.darkpony.com" onclick="javascript:window.open(this.href,
      '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"><i class="fa fa-google-plus"> </i> google+
                        ...
                        <div class="post-comments-number">
                            <span><a title="Σχόλια" href="{{ Request::url() }}#disqus_thread"></a></span>
                        </div>
                    </div>
                    ...
                    <div class="middle-advertisement-section">
                        <div class="row">
                            <div class="col-lg-12">
                                <a title="Advertisement" href="#"><img class="img-responsive top-banner-img" alt="Advertisement" src="theme/assets/img/banner_728x90.gif" /></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="promoted-posts-section">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6">
                                <a title="Post Title" href="#"><img class="img-responsive top-banner-img" alt="Advertisement" src="theme/assets/img/post-general.jpg" /></a>
                                <h1>Εξιτήριο για τον Τόλη Βοσκόπουλο</h1>
                            </div>
                            <?php endfor; ?>
                        </div>
                    </div>
