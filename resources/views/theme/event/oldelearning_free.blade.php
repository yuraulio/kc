               ...
               <div class="page-content">
                  ...
                  <div class="content-wrapper">
                     ...
                     @if($is_event_paid==0 && !Sentinel::getUser())
                        ...
                        <a href="{{ route('cart.add-item', [ $content->id,'free', 8 ]) }}" class="btn btn--lg btn--primary btn-tabs-ctr-toggle hidden-lg hidden-md visible-sm go-to-href">ENROLL FOR FREE</a>
                     
                     @elseif($is_event_paid==0 && Sentinel::getUser())

                        <a href="{{ route('enrollForFree',  $content->id) }}" class="btn btn--lg btn--primary btn-tabs-ctr-toggle hidden-lg hidden-md visible-sm go-to-href">ENROLL FOR FREE</a>
                           ...
                           <div id="topics" class="tab-content-wrapper">
                              <div class="video-wrapper video-point-scroll hidden-lg visible-xs">
                                 <div id="courses-tab" class="responsive-video" >
                                    @if($is_event_paid!=0 && $video_access)
                                    <?php $fv = 'https://player.vimeo.com/video/' . $last_video_seen . '?title=false' ?>
                                    <div class="initframe" data-vimeo-url="{{$fv}}" data-vimeo-width="auto" id="{vimeom}"></div>
                                    @endif
                                 </div>
                                 <!-- /.video-wrapper -->
                              </div>
