    	...
    	<div class="row">
	        ...
	        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	        	@if (!empty($section_syllabus_manager['featured']) && isset($section_syllabus_manager['featured'][0]) && isset($section_syllabus_manager['featured'][0]['media']) && !empty($section_syllabus_manager['featured'][0]['media']))
				    <img alt="{{ $frontHelp->pField($section_syllabus_manager, 'title') }}" title="{{ $frontHelp->pField($section_syllabus_manager, 'title') }}" src="{{ $frontHelp->pImg($section_syllabus_manager, 'users') }}" class="img-responsive" />
				@else
