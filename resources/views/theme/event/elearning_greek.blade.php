    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="text-align: center;">
                ...
                <a id="final-answer" href="#" class="btn btn-booknow-full sh-book">BOOK NOW</a>
            </div>
        </div>
    </div>
</div>
    ...
    $(document).ready(function() {
       ...
       // var owl_images = $("#owl-testimonials-images");
        ...
        owl.owlCarousel({
            ...
            nav:true,
            navText:["<span id='videos_carousel_back' class='testi-nav'><img  src='theme/assets/img/outline-left.svg' alt='Previous' title='Previous' /></span>",
               "<span id='videos_carousel_next' class='testi-nav'><img  src='theme/assets/img/outline-right.svg' alt='Next' title='Next' /></span>"],
            responsive : {
...
$(document).ready(function() {
    ...
    numberVideos = ({!!json_encode(preg_split("/(\r\n|\n|\r)/", $section_videos['c_fields']['simple_textarea']['value'])) !!})['length']
    if(numberVideos > 5){
      dots = numberVideos/5
    }else{
      dots = false
