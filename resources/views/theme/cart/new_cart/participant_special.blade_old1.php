							...
							<div class="form-wrp box" @if($i==1) id="clone-box" @else id="clone-box-{{$i}}" @endif>		
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										...
										<input name="student_type_id[]" type="text" class="form-control" value="{{old('student_type_id',$student_type_id[$i-1])}}" aria-describedby="inputGroupPrepend3" required>
								...
								<div class="form-row">
									<div class="col-md-6 mb-4 pr-md-3">
										...
										<input type="text" name="firstname[]" class="form-control with-focus-visible" value="{{old('firstname',$firstname[$i-1])}}"  required>
										<label id="firstname[{{$i-1}}]-error" class="error" for="firstname[{{$i-1}}]"></label>
									...
									<div class="col-md-6 mb-4 pl-md-3">
										...
										<input type="text" name="lastname[]" class="form-control" value="{{old('lastname',$lastname[$i-1])}}"  required>
										<div class="valid-feedback">
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										<label class="input-label">My e-mail is  <span class="checkout-required-data">(*)</span></label>							<div class="email-wrap">
												<input type="text" name="email[]"  value="{{old('email',$email[$i-1])}}" class="form-control" required>
										  	</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-12 mb-4 position-relative country-dropdown">
										...
										<select name="country_code[]" onchange="selectCountryCode(this,'{{$i}}')" class="form-control country{{$i}}" id="country">
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										...
										<input type="text" name="city[]" class="form-control" value="{{old('city',$city[$i-1])}}"  aria-describedby="inputGroupPrepend3">
										<div class="invalid-feedback">										
										</div>
									</div>
								</div>	
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										...
										<input name="company[]"  type="text" class="form-control" value="{{old('company',$company[$i - 1])}}"  aria-describedby="inputGroupPrepend3">			
									</div>
								</div>
								@endif
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										...
										<input type="text" name="jobtitle[]" value="{{old('jobtitle',$job_title[$i - 1])}}" class="form-control" placeholder="E.g. Marketing specialist" aria-describedby="inputGroupPrepend3">			
									</div>
								</div>	
								@if($type == 5 && $i>2)
