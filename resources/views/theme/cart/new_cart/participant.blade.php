					...
					<div class="participant-full-wrap">
                        ...
                        @csrf
							<div class="form-wrp box" id="clone-box">												
								<h2 class="participant-number">Participant 1</h2>	
								...
								<div class="form-row">
									<div class="col-md-6 mb-4 pr-md-3">
										...
										<input type="text" name="firstname[]" class="form-control with-focus-visible" value="{{old('firstname',$firstname)}}"  required>
									...
									<div class="col-md-6 mb-4 pl-md-3">
										...
										<input type="text" name="lastname[]" class="form-control" value="{{old('lastname',$lastname)}}"  required>
										<div class="valid-feedback">
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										<label class="input-label">My e-mail is  <span class="checkout-required-data">(*)</span></label>							<div class="email-wrap">
												<input type="text" name="email[]" id="email" value="{{old('email',$email)}}" class="form-control" required>
										  	</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-md-12 mb-4 position-relative country-dropdown">
                                        ...
                                        <input class="required" id="mobile" onkeyup="checkPhoneNumber(this)" type="number"  name="mobile[]" value="{{old('mobile',$mobile)}}"/>
                                        <label id="mobile-error" style="display:none" class="error" for="mobile"></label>
                                        <input type="hidden" name="mobileCheck[]" id="mobileCheck" value="{{old('mobile',$mobile)}}">
									</div>
								</div>	
								<div class="form-row">
									<div class="col-md-12 mb-4">
										<label class="input-label">Town or city I live in is</label>								
										<input type="text" class="form-control" value="{{old('city',$city)}}"  aria-describedby="inputGroupPrepend3">
										<div class="invalid-feedback">										
										</div>
									</div>
								</div>	
								...
								<div class="form-row">
									<div class="col-md-12 mb-4">
										...
										<input type="text" class="form-control" placeholder="E.g. Marketing specialist" aria-describedby="inputGroupPrepend3">			
									</div>
								</div>	
								<div class="form-row">
...
$(document).ready(function(){
    $("#country").val("{{old('country_code',$country_code)}}")
    $("#country").change();
})
