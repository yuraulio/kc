								        	...
								        	<!-- if($value->stock == 0)
    					    					...
    					    					<div class="dropdown">
    												...
    												<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    												    ...
    												    <a class="dropdown-item btn-add" href="{{ route('cart.add-item', [ $content->id, $value->ticket_id, 0 ]) }}">NORMAL</a>
    												</div>
    											</div>
		                        ...
		                        <tr>
		                          ...
		                          //  echo ($item->options->has('type') ? $item->options->type : ''); ?></td>
		                            <td>
		                                ...
		                                <input readonly id="item00<?php echo $item->model->id; ?>"  value="{{ $item->qty }}" name="update[{{ $item->rowId }}][quantity]" value="{{{ $item->qty }}}" class="qtyspinner" min="{{$min}}" max="5" />
			                        ...
			                        <div id="field<?php echo $i; ?>" class="acfield">
								        ...
								        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                                ...
                                                <div class="form-group endrow">
                                                    <input type="text" class="form-control" id="afm<?php echo $i; ?>" name="afm[]" placeholder="VAT number" value="@if(isset($pay_seats_data) && isset($pay_seats_data['afms'][$i])){{$pay_seats_data['afms'][$i]}}@endif">
                                                </div>
                                            </div>
...
$('select#newevent').on('change', function() {
  //alert( this.value );
