		...
		<div class="row">
		    <div class="col-lg-12">
		        ...
		        <div class="table-responsive">
		        	{!! Form::open(['route' => 'userPaySbt', 'method' => 'post', 'id' => 'sbt-pay', 'class' => 'cartForm']) !!}
		            <!-- <form role="form" method="post" action="cart/checkout" class="cartForm"> -->
		                        ...
		                        <tr>
		                          ...
		                          //  echo ($item->options->has('type') ? $item->options->type : ''); ?></td>
		                            <td>
		                                ...
		                                <input readonly id="item00<?php echo $item->model->id; ?>" type="text" value="{{ $item->qty }}" name="update[{{ $item->rowId }}][quantity]" value="{{{ $item->qty }}}" class="qtyspinner" min="{{$min}}" max="{{ $curStock }}" />
		                ...
		                <input type="hidden" name="count" value="1" />
			                    ...
			                    <?php endfor; ?>
			                        ...
			                        <!-- <button id="b1" class="btn btn-green add-more" type="button">+</button> -->
					...
					<div class="ckoutbx_option">
							...
							<!-- <div class="custom-checkbox" id="billing">
								<input class="c-box" type="checkbox" id="needbilling" name="needbilling" value="0" checked="checked"><label>My Billing details are the same as Seat #1 Above</label>
							</div> -->
							...
							<div class="btn-group" data-toggle="buttons" id="billing">
						        <label class="btn @if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 0) active @elseif(!isset($pay_bill_data['billing'])) active @endif">
						          <input type="radio" name="needbilling" value="0" @if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 0) checked @elseif(!isset($pay_bill_data['billing'])) checked @endif><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i><span> My Billing details are the same as Seat #1 above</span>
						        </label>
						        <label class="btn @if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1) active @endif">
						          <input type="radio" name="needbilling" value="1" @if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1) checked @endif ><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span>  My billing details are different</span>
						        </label>
					      	</div>
							<br />
						...
						<div class="ckoutbx_option">
                            ...
                            <div id="invoice-form" class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companyname" name="companyname" placeholder="ΕΠΩΝΥΜΙΑ ΕΤΑΙΡΙΑΣ" value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companyname'])){{$pay_invoice_data['companyname']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companyprofession" name="companyprofession" placeholder="ΔΡΑΣΤΗΡΙΟΤΗΤΑ ΕΤΑΙΡΙΑΣ" value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companyprofession'])){{$pay_invoice_data['companyprofession']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companyafm" name="companyafm" placeholder="Α.Φ.Μ." value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companyafm'])){{$pay_invoice_data['companyafm']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companydoy" name="companydoy" placeholder="ΔΟΥ" value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companydoy'])){{$pay_invoice_data['companydoy']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companyaddress" name="companyaddress" placeholder="ΔΙΕΥΘΥΝΣΗ" value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companyaddress'])){{$pay_invoice_data['companyaddress']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companyaddressnum" name="companyaddressnum" placeholder="ΑΡΙΘΜΟΣ" value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companyaddressnum'])){{$pay_invoice_data['companyaddressnum']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companypostcode" name="companypostcode" placeholder="Τ.Κ." value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companypostcode'])){{$pay_invoice_data['companypostcode']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="companycity" name="companycity" placeholder="ΠΟΛΗ" value="@if(isset($pay_invoice_data) && isset($pay_invoice_data['companycity'])){{$pay_invoice_data['companycity']}}@endif">
                                    </div>
                                </div>
                            </div>
                            <br />
					...
					<!-- Form::open(['route' => 'userPaySbt', 'method' => 'post', 'id' => 'sbt-pay', 'class' => 'form-horizontal']) -->
						...
						<!-- <select class="selectpicker">
						  <option>Credit Card (1-3 installments)</option>
						  <option>Debit Card (no installments)</option>
						</select> -->
						<br />
					...
					@endif
		                ...
		                <!-- <a href="{{ route('cart.destroy') }}" class="btn btn-booknow andnormal">Empty Cart</a> data-toggle="tooltip"-->
		                <div class="mobileFR">
		                	<div class="custom-checkbox-uni" id="terms" >
							<!-- <input class="c-box" id="accept" type="checkbox" value="0" name="accept" required="" checked="checked"><label><a id="toggleterms" href="javascript:void(0)" >I agree &amp; accept the terms &amp; conditions</a></label> -->
							...
							<a target="_blank" title="View Terms and conditions" href="/terms-privacy">View Terms and conditions</a>
							</div> -->
							<br />
		                   ...
		                   <!--  <button type="submit" class="btn btn-green-invert do-checkout">Checkout</button> -->
		                   <div class="mobileR">
		                    {!! Form::submit('PAY NOW', ['class' => 'btn btn-booknow-full do-checkout']) !!}
		                	</div>
		           ...
		           <!--  data-placement="top" title="1) <b>Booking:</b> This is binding booking. By registering you agree to <b>a full ticket payment</b>.<br><br>
	...
	<!-- <div class="container">
        <div class="row">
            ...
            <div class="control-group" id="fields">
                <label class="control-label" for="field1">Personal Details</label>
                <div class="controls" id="profs">
                    <form class="input-append">
                        <div class="field"><input autocomplete="off" class="input" id="field1" name="prof1" type="text" placeholder="Type something" data-items="8"/><button id="b1" class="btn add-more" type="button">+</button></div>
                    </form>
                <br>
                <small>Press + to add another person :)</small>
                <br>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="payment-tile">
                                <a target="_blank" href="#" title="Payment Logo">
...
<script>
              ...
              //.TouchSpin({});touchspin.on.stopspin
...
$(function () {
    /*$("input.qtyspinner").on("change paste", function () {
        updateData($(this).val(), $(this).attr('max'));
    });*/

    $("input.qtyspinner").on('input paste',function(e){

    	//updateData($(this).val(), $(this).attr('max'));
    });

    /*$("input.qtyspinner").debounce("keyup", function() {
        updateData($(this).val(), $(this).attr('max'));
    }, 500);*/



    /*$("input.qtyspinner").on("paste", function() {
         updateData($(this).val(), $(this).attr('max'));
    });*/
...
function updateData(v, m) {
	...
	if (v < m) {
  		...
  		alert('nooo'+v+'|'+m+'|');
              ...
              /*$("input.qtyspinner").on('input',function(e){
