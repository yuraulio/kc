		        ...
		        <div class="table-responsive">
		                ...
		                <table class="table table-striped table-bordered table-hover">
		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                          ...
		                          //  echo ($item->options->has('type') ? $item->options->type : '');
			                        ...
			                        <div id="field<?php echo $i; ?>" class="acfield">
								        ...
								        <div class="row">
								            ...
								            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
									            ...
									            <div class="form-group endrow">
								            		<input type="text" class="form-control" id="afm<?php echo $i; ?>" name="afm[]" placeholder="Personal VAT number" value="@if(isset($pay_seats_data) && isset($pay_seats_data['afms'][$i])){{$pay_seats_data['afms'][$i]}}@endif">
								            	</div>
								            </div>
					...
					<div class="ckoutbx_option">
							...
							<div class="btn-group" data-toggle="buttons" id="billing">
						        ...
						        <label class="btn @if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1) active @elseif(!isset($pay_bill_data['billing'])) active @endif">
						          <input type="radio" name="needbilling" value="1" @if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1) checked @elseif(!isset($pay_bill_data['billing'])) checked @endif ><i class="fa fa-circle-o fa-2x"></i><i class="fa fa-dot-circle-o fa-2x"></i> <span>  I need a receipt</span>
						        </label>
						        <!-- <span>  Receipt details are different</span> -->
                            ...
                            <div id="billing-form" style="@if(isset($pay_bill_data) && isset($pay_bill_data['billing']) && $pay_bill_data['billing'] == 1) display:block @elseif(!isset($pay_bill_data['billing'])) display:block @endif" class="row">
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billname" name="billname" placeholder="ΟΝΟΜΑ" value="@if(isset($pay_bill_data) && isset($pay_bill_data['billname'])){{$pay_bill_data['billname']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billsurname" name="billsurname" placeholder="ΕΠΙΘΕΤΟ" value="@if(isset($pay_bill_data) && isset($pay_bill_data['billsurname'])){{$pay_bill_data['billsurname']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billmobile" name="billmobile" placeholder="ΚΙΝΗΤΟ" value="@if(isset($pay_bill_data) && isset($pay_bill_data['billmobile'])){{$pay_bill_data['billmobile']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billaddress" name="billaddress" placeholder="ΔΙΕΥΘΥΝΣΗ" value="@if(isset($pay_bill_data) && isset($pay_bill_data['billaddress'])){{$pay_bill_data['billaddress']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billaddressnum" name="billaddressnum" placeholder="ΑΡΙΘΜΟΣ" value="@if(isset($pay_bill_data) && isset($pay_bill_data['billaddressnum'])){{$pay_bill_data['billaddressnum']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billpostcode" name="billpostcode" placeholder="Τ.Κ." value="@if(isset($pay_bill_data) && isset($pay_bill_data['billpostcode'])){{$pay_bill_data['billpostcode']}}@endif">
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-6  col-xs-12">

                                    <div class="form-group">
                                        <input type="text" class="form-control" id="billcity" name="billcity" placeholder="ΠΟΛΗ" value="@if(isset($pay_bill_data) && isset($pay_bill_data['billcity'])){{$pay_bill_data['billcity']}}@endif">
                                    </div>
                                </div>
                            </div>
					...
					<h3>Payment Options</h3>
						...
						<div class="btn-group" data-toggle="buttons" id="cardtype">
				      	...
				      	<div id="installments-form" style="<?php if(isset($cardtype) && $cardtype == 2) echo 'display:block;'; ?>" class="btn-group" data-toggle="buttons">
					        ...
					        <br />
					        <p>Some international credit cards and AMEX cards do not accept installments.</p>
				      	</div>
