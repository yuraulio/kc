                                                                            ...
                                                                            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                        <div>
                                                                                            <p style="margin: 0px;">All the students will present their complete digital marketing strategies and they need you to give them your valuable feedback.</p>
                                                                                            <p style="margin-top: 10px; margin-bottom: 10px;">See you in the class on <strong>{{$date}}</strong> at <strong>{{$time}}</strong></p>
                                                                                            <p style="margin: 0px;">Location: <strong>{{$location}}</strong></p>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="nl2go-responsive-hide">
                                                                        ...
                                                                        <td class="r12-c" align="left">
                                                                            <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                        <div>
                                                                                            <p style="margin: 0px;">Please note that your attendance is mandatory.</p>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr class="nl2go-responsive-hide">
