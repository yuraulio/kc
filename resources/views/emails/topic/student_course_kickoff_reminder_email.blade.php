@extends('emails.user.layouts.master') @section('email_body') <tr>
                                                                                ...
                                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" class="r14-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                            <div>
                                                                                                <h2 class="default-heading2" style="color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 32px; margin: 0px;"><span style="font-family: Tahoma, geneva, sans-serif;">{{ $firstname }} {{$lastname}}</span></h2>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            ...
                                                                            <td class="r12-c" align="left">
                                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" class="r14-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                            <div>
                                                                                                <h2 class="default-heading2" style="color: #1F2D3D; font-family: arial,helvetica,sans-serif; font-size: 32px; margin: 0px;">
                                                                                                    <span style="font-family: Tahoma, geneva, sans-serif;">Σε καλωσορίζουμε στο {{$eventTitle}}</span>
                                                                                                </h2>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                ...
                                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                            <div>
                                                                                                <p style="margin: 0px;">Μερικές χρήσιμες πληροφορίες:</p>
                                                                                                <ul style="margin: 0px;">
                                                                                                    <li>Ημέρα έναρξης: <strong>{{$date}}</strong></li>
                                                                                                    <li>Ώρα προσέλευσης: <strong>{{$time}}</strong></li>
                                                                                                    <li>Τοποθεσία: <strong>{{$location}}</strong></li>
                                                                                                </ul>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                            ...
                                                                            <td class="r12-c" align="left">
                                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                            <div>
                                                                                                <p style="margin: 0px;">To πρόγραμμα βρίσκεται και μέσα στο My Courses αφού κάνεις log in στο account σου.</p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="nl2go-responsive-hide">
                                                                            ...
                                                                            <td class="r12-c" align="left">
                                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                            <div>
                                                                                                <p style="margin: 0px;">Είναι τιμή μας που μας επέλεξες, σου υποσχόμαστε ένα θαυμάσιο ταξίδι γεμάτο όμορφες δυνατές στιγμές και έμπνευση.</p>
                                                                                                <p style="margin: 0px;">Σε αναμένουμε στο course!</p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="nl2go-responsive-hide">
