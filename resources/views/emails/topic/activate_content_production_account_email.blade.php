                                                                                ...
                                                                                <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                                            <div>
                                                                                                <p style="margin: 0px;">As you are about to start the Content Production section, in which you will learn how to create content, we encourage you to<strong> create an account </strong>for <a href="https://www.canva.com/" title="Canvas" target="_blank" style="color: #0092ff; text-decoration: underline;">Canvas.com</a>. It's free to use.</p>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr class="nl2go-responsive-hide">
