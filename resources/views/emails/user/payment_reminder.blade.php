                                                                     ...
                                                                     <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                           <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                              <div>
                                                                                 <p style="margin: 0px;"><span style="font-family: Tahoma, geneva, sans-serif;">­Your upcoming payment for {{$eventTitle}} is due on <strong>{{$paymentDate}}</strong>.</span></p>
                                                                                 <p style="margin: 0px;"> </p>
                                                                                 <br>
                                                                                 <p style="margin: 0px;"><span style="font-family: Tahoma, geneva, sans-serif;">Payment will be processed automatically by our system on that date and you will get a receipt for your successful payment.</span></p>
                                                                                 <p style="margin: 0px;"> </p>
                                                                                 <br>
                                                                                 <p style="margin: 0px;"><span style="font-family: Tahoma, geneva, sans-serif;">Feel free to contact us for any further assistance regarding your payments. </span></p>
                                                                              </div>
                                                                           </td>
                                                                        </tr>
                                                                        <tr class="nl2go-responsive-hide">
