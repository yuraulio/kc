                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                        ...
                                        <td class="r12-c" align="left">
                                            ...
                                            <tr>
                                                ...
                                                <div>
                                                    <p style="margin: 0;">
                                                    <span style="font-family: Tahoma, geneva, sans-serif;">Thank you for your interest in our <strong>{{$eventTitle}}</strong>. We noticed you did not complete your registration.  </span>
                                                    </p>
                                                    <p style="margin: 0;"></p>
                                                    <p style="margin: 0;">
                                                    ...
                                                    <p style="margin: 0;">
                                                    <span style="font-family: Tahoma, geneva, sans-serif;">USE the coupon <strong>"CYBERMONDAY24"</strong> and get 40% discount now for the <strong>{{$eventTitle}}</strong>.
                                                    </p>
