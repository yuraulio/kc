                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation">
                                        ...
                                        <td class="r12-c" align="left">
                                            ...
                                            <tr>
                                                ...
                                                <div>
                                                    <p style="margin: 0;">
                                                    <span style="font-family: Tahoma, geneva, sans-serif;">Time is running out! Only few hours remain to complete your resgistation. Don't miss out on today's 40% discount - start watching <strong>{{$eventTitle}}</strong> now.  </span>
                                                    </p>
                                                    ...
                                                    <span style="font-family: Tahoma, geneva, sans-serif;"> today by using the coupon <strong>"CYBERMONDAY24"</strong> at checkout. Get full access to the course for only <strong>€{{$DiscountedPrice}}</strong>. </span>
                                                    </p>
                                                </div>
                                                </td>
                                            </tr>
