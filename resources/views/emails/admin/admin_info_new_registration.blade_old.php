...
@if(isset($user['id']))<a target="_blank" href="http://www.knowcrunch.com/admin1/user/{{$user['id']}}/edit">Check the registration details online</a>.<br /><br />@endif
<!--<a target="_blank" href="https://kclioncode.j.scaleforce.net/admin1/transaction/edit/{{ $trans->id }}">Check the registration details online</a>.<br /><br />-->
