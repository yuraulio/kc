                                                                     ...
                                                                     <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="100%" class="r13-o" style="table-layout: fixed; width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                           <td align="left" valign="top" class="r15-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5; text-align: left;">
                                                                              <div>
                                                                                 <p style="margin: 0px;"><span style="font-family: Tahoma, geneva, sans-serif;">The account for the email: <strong>{{ $email }}</strong> is now active and you can access it anytime. </span></p>
                                                                              </div>
                                                                           </td>
                                                                        </tr>
                                                                        <tr class="nl2go-responsive-hide">
                                                                     ...
                                                                     <table cellspacing="0" cellpadding="0" border="0" role="presentation" width="290" class="r16-o" style="table-layout: fixed; width: 290px;">
                                                                        ...
                                                                        <tr>
                                                                           <td height="19" align="center" valign="top" class="r17-i nl2go-default-textstyle" style="color: #3b3f44; font-family: arial,helvetica,sans-serif; font-size: 16px; line-height: 1.5;">
                                                                              <!--[if mso]> 
                                                                              <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://knowcrunch.com/?utm_source=Knowcrunch.com&utm_medium=Registration_Email" style="v-text-anchor:middle; height: 42px; width: 289px;" arcsize="10%" fillcolor="#c8d151" strokecolor="#c8d151" strokeweight="1px" data-btn="1">
                                                                                 <w:anchorlock/>
                                                                                 <div style="display:none;">
                                                                                    <center class="default-button">
                                                                                       <p><span style="color:#030000;font-family:Tahoma, geneva, sans-serif;"><strong>Access your account</strong></span></p>
                                                                                    </center>
                                                                                 </div>
                                                                              </v:roundrect>
                                                                              <![endif]-->  <!--[if !mso]><!-- --> 
