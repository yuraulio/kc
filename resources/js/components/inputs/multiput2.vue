            ...
            <div class="text-center">
                <div class="d-grid text-center" v-if="value">
                    <img
                        ...
                        :data-bs-target="'#mediaCanvas2' + keyput"
                ...
                <div v-else>
                    <i
                        ...
                        data-bs-toggle="offcanvas"
                        :data-bs-target="'#mediaCanvas2' + keyput"
                        class="text-muted dripicons-photo d-none image-input-icon"
                    ...
                    <button
                        ...
                        class="btn btn-soft-primary image-input-button d-none"
                    >
                        <template v-if="imageEdit"> Edit Media </template>
                        <template v-else> Add Media </template>
                    </button>
                </div>
            </div>
        </div>
                        ...
                        <div v-for="(val, index) in value" class="col-sm-3 mb-2">
                            ...
                            <p class="mb-0">
                                ...
                                <i
                                    ...
                                    class="mdi mdi-delete text-muted vertical-middle"
                                ></i>
                            </p>
                        </div>
                        <div class="col-sm-3">
