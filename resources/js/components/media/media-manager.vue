            ...
            <div class="row p-4">
                <div class="col-12">
                    ...
                    <p class="mb-2">
                        ...
                        <br />
                        <span class="d-inline-block" style="width: 40px">To: </span
                                        ...
                                        >
                                            <div class="row g-0 ps-1">
                                                <div class="col-auto p-0">
                                                    <i
                                                        class="mdi mdi-folder-outline font-18 align-middle"
                                                ...
                                                <div class="col-auto p-0">
                                                    ...
                                                    ></i>
                                                    <i
                                                        @click.stop="renameFolderModal(item)"
                                                        class="fas fa-edit ms-1 mt-1 cursor-pointer"
                                                    ></i>
                                                </div>
                                            </div>
                                        </div>
