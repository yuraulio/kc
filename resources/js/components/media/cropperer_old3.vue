    ...
    <div class="row cropper-data">
      ...
      <div class="col-sm-4 image-data">
        ...
        <div class="row mb-2">
          ...
          <div class="col-4">
            <button type="button" @click="reset()" class="btn btn-soft-info btn-block w-100 mt-2">Reset</button>
          </div>
          <div class="col-4">
            <button type="button" @click="close()" class="btn btn-soft-secondary btn-block w-100 mt-2">Cancel</button>
          </div>
          <div class="col-12">
            <button
          ...
          <div class="p-1">
            <template v-if="findVersionData(version1.version) != null">
              <img
                ...
                alt="image"
                class="img-fluid rounded"
                :style="version == version1.version ? 'border: 4px solid #1abc9c;' : 'border: 4px solid #f3f7f9;'"
              />
              <!--
