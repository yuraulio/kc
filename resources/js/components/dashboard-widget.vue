    ...
    <div class="col-md-6 col-xl-3">
        <div class="card widget-min-height" id="tooltip-container">
            <div class="card-body">
                ...
                <h2 v-if="value" class="text-primary my-3 text-center">
                    <span>{{ value }}</span>
                </h2>
                ...
                ></vue-loaders-ball-beat>
                <p v-if="students_in_class" class="text-muted mb-0">
                    In class: {{ students_in_class }}
    ...
    methods: {
        getData() {
            ...
            axios
                ...
                .then((response) => {
                    if (this.type == 'students' || this.type == 'students_all') {
                    ...
                    } else if (this.type == 'instructors') {
                        this.students_in_class = response.data['data'][0];
                        this.students_in_online = response.data['data'][1];
                        this.value = response.data['data'][2];
                    } else {
