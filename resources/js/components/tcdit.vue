            ...
            <div v-if="name == 'main'" class="row mb-1">
                <div class="col-12">
                    <ul class="nav nav-pills nav-fill">
                        ...
                        <li class="nav-item">
                            <a @click="tab = 'Meta'" :class="'nav-link ' + (tab == 'Meta' ? 'active' : '')" href="#!"
                                >SEO</a
                            >
                        </li>
                    </ul>
                    ...
                    <nav class="nav nav-pills flex-column flex-sm-row navtab-bg">
                        <template v-for="(tab_item, tab_index) in tabs">
                            <a
                                ...
                                :class="
                                    'mb-1 me-1 ms-0 flex-sm-fill text-sm-center nav-link ' +
                                    (tabs_tab == tab_item ? 'active' : '')
                                "
                                href="#!"
                            >
                                ...
                                <div class="card-body pb-3">
                                        ...
                                        <ul class="nav nav-pills navtab-bg nav-justified">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        @click="changeComponent(index, ind, column.template)"
                                                ...
                                                <div v-if="v.template.dynamic != null" class="d-block text-center ms-2">
                                                    <span
                                                        class="text-muted font-13 d-inline-block me-1"
                                                        style="margin-top: 4px"
                                                        >Dynamic</span
                                                    ><input
                                                        v-model="v.template.dynamic"
                                                        type="checkbox"
                                                ...
                                                <div
                                                    v-if="checkComponentVersion(v)"
                                                    class="alert alert-warning m-2"
                                                    role="alert"
                                                >
                                                    This component is updated. Refresh to get new version. Refresh will
                                                    delete data.
                                                    <i
                                    ...
                                    <template v-else>
                                        <h5 :class="'card-title mb-0 ' + getColumnWidth(column, val.columns)">
                                            <div
                                                @click="changeComponent(index, 0, column.template)"
                                            ...
                                            >
                                                <div
                                                    @click="split(val.columns, indr, 'push')"
                                                    class="ms-3 mr-2 d-inline-block cursor-pointer"
                                                >
                                                    Add column
                                                </div>
                                            </span>
                                            <div
                                                v-if="column.template.dynamic != null"
                                                class="d-inline-block float-end ms-2"
                                            >
                                                <span
                                                    class="text-muted font-13 d-inline-block me-1"
                                                    style="margin-top: 4px"
                                                    >Dynamic</span
                                                ><input
                                                    v-model="column.template.dynamic"
                                                    type="checkbox"
                                                    class="form-check-input"
                                                />
                                            </div>
                                            ...
                                            <div v-if="column.template.mobile != null" class="d-inline-block float-end">
                                                <span
                                                    ...
                                                    >Show on mobile</span
                                                ><input
                                                    v-model="column.template.mobile"
                                                    type="checkbox"
                                                    class="form-check-input"
                                                />
                                            </div>
                                        ...
                                        <div
                                            v-if="checkComponentVersion(column)"
                                            class="alert alert-warning m-2"
                                            role="alert"
                                        >
                                            This component is updated. Refresh to get new version. Refresh will delete
                                            data.
                                            <i
                                        ...
                                        <template v-if="column.component == 'html'">
                                            <div class="card-body row pb-0 pt-0">
                                                <div class="col-12">
                                                    ...
                                                    <br />
                                                    <p
                                                        v-html="findInputValue(column.template.inputs, 'html_embed')"
                                                    ></p>
                                                </div>
                                            </div>
                                        </template>
                ...
                <div class="col-sm-12 mt-3 mb-3">
                    <div class="page-title-box row">
                        <div class="col-md-6">
                            <input
                                :value="pageTitle"
                                @change="updateTemplateTitle"
                                class="d-inline-block title-input"
                            />
                        </div>
                        <div class="col-md-6">
...
export default {
    ...
    methods: {
        ...
        checkComponentVersion(column) {
            ...
            if (
                this.extractedComponents[column.component] &&
                this.extractedComponents[column.component].version > version
            ) {
                return true;
            }
            return false;
