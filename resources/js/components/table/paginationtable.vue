          ...
          <div class="col-md-auto pt-3 d-flex align-items-center">
            <div>
              ...
              <span
                ...
                class="badge bg-primary ms-1 cursor-pointer"
                >Transaction From: {{ formatdate(transaction_from) }} <i class="fa fa-times" aria-hidden="true"></i
              ></span>
              <span
                @click="!loading ? ((transaction_to = null), refreshTable()) : {}"
                v-if="transaction_to"
                class="badge bg-primary ms-1 cursor-pointer"
                >Transaction To: {{ formatdate(transaction_to) }} <i class="fa fa-times" aria-hidden="true"></i
              ></span>
            </div>
          </div>
