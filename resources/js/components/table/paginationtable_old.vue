                    ...
                    <div class="card bg-pattern mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="text-end">
                                        <h3 class="text-dark my-1 text-truncate" :title="widgets[0][1]">
                                            <span>{{ widgets[0][1] }}</span>
                                        </h3>
                    ...
                    <div class="card bg-pattern mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="text-end">
                                        <h3 class="text-dark my-1 text-truncate" :title="widgets[1][1]">
                                            <span>{{ widgets[1][1] }}</span>
                                        </h3>
                    ...
                    <div class="card bg-pattern mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="text-end">
                                        <h3 class="text-dark my-1 text-truncate" :title="widgets[2][1]">
                                            <span>{{ widgets[2][1] }}</span>
                                        </h3>
                    ...
                    <div class="card bg-pattern mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="text-end">
                                        <h3 class="text-dark my-1 text-truncate" :title="widgets[3][1]">
                                            <span>{{ widgets[3][1] }}</span>
                                        </h3>
