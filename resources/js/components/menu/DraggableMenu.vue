  ...
  <ol class="dd-list">
    <li v-for="list in lists" :key="list.id" class="dd-item" :data-order="list.order" :data-id="list.id">
      ...
      <div class="action-area">
        <a href="#" style="margin-top: 7px" class="action-icon" v-on:click="editMenuItem(list.id)" :data-id="list.id">
          <i class="mdi mdi-square-edit-outline"></i>
        </a>
        <a href="#" style="margin-top: 7px" class="action-icon" v-on:click="deleteMenuItem(list.id)" :data-id="list.id">
