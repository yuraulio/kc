      ...
      <div class="row p-4">
        <div class="col-lg-12 p4">
          <text-field
            ...
            required="1"
          ></text-field>
          <ul v-if="errors && errors['title']" class="parsley-errors-list filled" id="parsley-id-7" aria-hidden="false">
        ...
        <div class="col-lg-12 text-center mt-3">
          <button
            ...
            :disabled="loading"
          >
            <i v-if="!loading" class="fe-check-circle me-1"></i><i v-else class="fas fa-spinner fa-spin"></i> Save
          </button>
          <button
            v-if="type == 'edit'"
            :disabled="loading"
