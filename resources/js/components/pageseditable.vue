        ...
        <div class="col-sm-12 mt-3 mb-3">
            <div class="page-title-box">
                ...
                <button
                    ...
                    @click="changeMode()"
                    type="button"
                    class="btn btn-soft-info waves-effect waves-light float-end"
                >
                    Page
                </button>
                <button
                    v-if="type != 'new'"
                    @click="preview()"
                    class="btn btn-block btn-soft-warning waves-effect waves-light me-2 float-end"
                >
                    Live preview
                </button>
                <!--
                ...
                <button
                    ...
                    :disabled="loading"
                >
                    <i v-if="loading" class="fas fa-spinner fa-spin"></i> Create
                </button>
                <button
                    v-if="type == 'edit'"
                    :disabled="loading"
                ...
                <a href="/pages" type="button" class="btn btn-soft-secondary waves-effect waves-light me-2 float-end"
                    >Cancel</a
                >
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body pb-0">
                    ...
                    <ul
                        ...
                        class="parsley-errors-list filled mb-3"
                        id="parsley-id-7"
                        aria-hidden="false"
                    >
            ...
            <div class="card">
                <div class="card-body">
                    <button
                        ...
                        class="btn btn-sm btn-soft-secondary w-100 mb-3"
                        type="button"
                        data-bs-toggle="collapse"
                        aria-expanded="false"
                        aria-controls="collapseExample"
                    >
                        <template v-if="collapseAll == true"> Collapse All </template>
...
export default {
    ...
    methods: {
        ...
        preview() {
            window.open(process.env.MIX_APP_URL + '/__preview/' + this.data.uuid + '?p=HEW7M9hd8xY2gkRk', '_blank');
        },
    },
    mounted() {
        if (this.data) {
