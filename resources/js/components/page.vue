          ...
          <div class="col-11">
            ...
            <div class="text-muted d-flex justify-content-between mb-2">
              <div v-if="page.template" class="text-uppercase">
                ...
                <small>
                  <a
                    :href="'/templates?id=' + page.template.id + '&title=' + page.template.title + '&preview=' + true"
            ...
            <p class="mb-0 pb-0">
              ...
              <span class="pe-2 text-nowrap d-inline-block" style="float: right">
                <a :href="'/page/' + page.id" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
              </span>
