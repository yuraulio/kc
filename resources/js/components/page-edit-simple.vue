                            ...
                            <template v-if="type != 'new'">
                                ...
                                <template v-if="!page.dynamic">
                                    <template v-if="page.published">
                                        ...
                                        />
                                        <label
                                            class="btn btn-outline-primary float-end ms-2 mb-3"
                                            for="btn-check-outlined"
                                            ><i class="dripicons-checkmark me-1" style="transform: translateY(2px)"></i
                                            >Published</label
                                        >
                                    </template>
                                    <template v-else>
                                        ...
                                        <label
                                            class="btn btn-outline-primary float-end ms-2 mb-3"
                                            for="btn-check-outlined"
                                            ><i class="dripicons-cross me-1" style="transform: translateY(2px)"></i>
                                            Unpublished</label
                                        >
                                    </template>
                                </template>
                ...
                <template v-for="(column, column_index) in row.columns">
                    <template v-if="column.template.simple_view == true && column.template.tab == tab">
                        <div :class="'row ' + 'row' + row_index">
                            <div class="col-md-8 offset-md-2 align-self-center">
                                <div
                                    :class="'card ' + 'column' + column_index"
                                    :style="column_index == 0 ? '' : 'display: none;'"
                                >
                                    <div class="card-body">
                                        <div
                                            :class="
                                                'row component-tabs ' + (column.tab == 'settings' ? 'settings' : 'main')
                                            "
                                        >
                                            <div class="col-12">
                                                ...
                                                <template v-if="simpleColumnCount(row.columns) > 1">
                                                    ...
                                                    >
                                                        <template v-for="(column, column_index) in row.columns">
                                                            <li
                                                                :class="
                                                                    'nav-item d-inline-block nav-column' + column_index
                                                                "
                                                            >
                                                                <a
                                            ...
                                            <template v-if="column.component == 'html'">
                                                <div class="card-body row pb-0 pt-0">
                                                    <div class="col-12">
                                                        ...
                                                        <p
                                                            v-html="
                                                                findInputValue(column.template.inputs, 'html_embed')
                                                            "
                                                        ></p>
                                                    </div>
                                                </div>
