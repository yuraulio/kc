                ...
                <div class="col">
                    ...
                    <div @change="saveSetting(settings.cms_mode)" class="d-inline-block">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="old" v-model="settings.cms_mode.value">
                            <label class="form-check-label" for="exampleRadios1">
                                Old pages
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="new" v-model="settings.cms_mode.value">
                            <label class="form-check-label" for="exampleRadios2">
                                New pages + old pages as backup
                            </label>
                        </div>
                    </div>
                </div>
