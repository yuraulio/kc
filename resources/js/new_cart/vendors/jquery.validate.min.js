  ...
  a.extend(a.fn, {
    ...
    rules: function (b, c) {
      ...
      return (
        ...
        g.required &&
          ((h = g.required), delete g.required, (g = a.extend({ required: h }, g)), a(j).attr('aria-required', 'true')),
      ...
      prototype: {
        ...
        previousValue: function (b) {
          return (
            ...
            a.data(b, 'previousValue', { old: null, valid: !0, message: this.defaultMessage(b, 'remote') })
          );
        },
      },
      classRuleSettings: {
