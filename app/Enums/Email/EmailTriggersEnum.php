...
enum EmailTriggersEnum: string
{
    public static function getEmailTriggers(): array
    {
        return [
            ...
            ['key' => 'ExamActivate', 'label' => 'Elearning exam activation email', 'variables'=> ['{{params.FNAME}}', '{{params.CourseName}}', '{{params.LINK}}']],
            ...
            ['key' => 'InstructorWorkshopReminder', 'label' => 'Instructor class workshop reminder email', 'variables'=>['{{params.Location}}', '{{params.Time}}', '{{params.Date}}', '{{params.CourseName}}', '{{params.FNAME}}']],
            ...
            ['key' => 'InClassReminder', 'label' => "Students' class kick-off reminder email (7 days before)", 'variables'=> ['{{params.DATE}}', '{{params.LOCATION}}', '{{params.DURATION}}', '{{params.ADDRESS}}', '{{params.LINK}}', '{{params.CourseName}}', '{{params.FNAME}}']],
            ...
            ['key' => 'ExpirationMailsMasterClass', 'label' => 'Subscription expiration before the course email', 'variables'=> ['{{params.LINK}}', '{{params.SubscriptionPrice}}', '{{params.ExpirationDate}}', '{{params.CourseName}}', '{{params.FNAME}}']],
