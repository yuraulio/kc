...
class Metas extends Model
{
    ...
    public function getMetas($isHomePage = false)
    {
        ...
        $metas =
            ...
            '<meta property="og:image" content="' . url('/') . get_image($this->metable->mediable, 'header-image') . '">' .
            ...
            '<meta name="twitter:image" content="' . url('/') . get_image($this->metable->mediable, 'header-image') . '">';
