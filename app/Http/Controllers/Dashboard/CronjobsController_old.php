...
class CronjobsController extends Controller
{
    ...
    public function generateCSVForFB(){
        ...
        $events = Event::where('view_tpl','!=','event_free')->where('index',true)->where('view_tpl','!=','elearning_free')->where('published',true)->whereIn('status',[0])->with('category', 'ticket','mediable')->get();
