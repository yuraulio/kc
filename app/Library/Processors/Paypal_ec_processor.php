...
class Paypal_ec_processor
{
    ...
    */
    public function hash_call($methodName = '', $nvpStr = '', $payment_options = [])
    {
        $retdata = [];
        $retdata['processor_response'] = [];
        $retdata['status'] = 0;
        //$retdata['processor_order_id'] = 0;
        $retdata['website_response'] = 'redirect';
        $retdata['redirect_url'] = '';
    ...
    *  Returns:
    */
    public function RedirectToPayPal($token = '', $payment_options = [])
    {
        if ($payment_options['sandbox_flag'] == 1) {
            $pp_checkout_url = $payment_options['pp_checkout_url_sandbox'];
        } else {
    ...
    */
    public function GetExpressCheckoutDetails($token = '', $payment_method_details = [])
    {
    ...
    */
    public function DoExpressCheckoutPayment($response = [], $payment_method_details = [])
    {
