...
class Alphabank_processor
{
    ...
    public function submit_form($data = [])
    {
        ...
        $sbt_data['orderid'] = 'KCORDTN' . $data['order_details']['id']; //KCORDTN
        $sbt_data['payment_method_id'] = $data['order_details']['payment_method_id'];

        $sbt_data['billCountry'] = $data['order_details']['billing_details']['billcountry'];
        $sbt_data['billState'] = $data['order_details']['billing_details']['city'];
        $sbt_data['billZip'] = $data['order_details']['billing_details']['billzip'];
        $sbt_data['billCity'] = $data['order_details']['billing_details']['city'];
